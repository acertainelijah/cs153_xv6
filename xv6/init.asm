...
main(void)
{
  ...
  61:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  63:	78 34                	js     99 <main+0x99>
      printf(1, "init: fork failed\n");
      exit(0);
    }
    if(pid == 0){
  65:	74 4c                	je     b3 <main+0xb3>
  ...
  73:	6a 00                	push   $0x0
  75:	e8 e0 02 00 00       	call   35a <wait>
  ...
  b3:	50                   	push   %eax
  b4:	50                   	push   %eax
  b5:	68 b4 0a 00 00       	push   $0xab4
  ba:	68 ee 07 00 00       	push   $0x7ee
  bf:	e8 c6 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  c4:	5a                   	pop    %edx
  c5:	59                   	pop    %ecx
  c6:	68 f1 07 00 00       	push   $0x7f1
  cb:	6a 01                	push   $0x1
...
main(void)
{
  ...
  df:	6a 01                	push   $0x1
  e1:	6a 01                	push   $0x1
  e3:	68 c0 07 00 00       	push   $0x7c0
  e8:	e8 ad 02 00 00       	call   39a <mknod>
    open("console", O_RDWR);
  ed:	58                   	pop    %eax
  ee:	5a                   	pop    %edx
  ef:	6a 02                	push   $0x2
  f1:	68 c0 07 00 00       	push   $0x7c0
