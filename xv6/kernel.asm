...
801001ae:	e8 4d 43 00 00       	call   80104500 <holdingsleep>
...
801001ef:	e8 0c 43 00 00       	call   80104500 <holdingsleep>
...
801001ff:	e8 bc 42 00 00       	call   801044c0 <releasesleep>
...
8010025b:	5d                   	pop    %ebp
  ...
  release(&bcache.lock);
8010025c:	e9 ef 44 00 00       	jmp    80104750 <release>
// Move to the head of the MRU list.
void
brelse(struct buf *b)
{
...
801002e6:	e8 65 44 00 00       	call   80104750 <release>
        ilock(ip);
...
80100346:	e8 05 44 00 00       	call   80104750 <release>
  ilock(ip);
...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 a3 7c 10 80 	movl   $0x80107ca3,(%esp)
...
8010050d:	8d b4 1b 00 80 0b 80 	lea    -0x7ff48000(%ebx,%ebx,1),%esi
  ...
  if((pos/80) >= 24){  // Scroll up.
    memmove(crt, crt+80, sizeof(crt[0])*23*80);
80100514:	e8 37 43 00 00       	call   80104850 <memmove>
    pos -= 80;
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100529:	e8 72 42 00 00       	call   801047a0 <memset>
...
80100647:	e8 04 41 00 00       	call   80104750 <release>
  ilock(ip);
8010064c:	58                   	pop    %eax
...
8010070d:	e8 3e 40 00 00       	call   80104750 <release>
...
80100868:	e8 e3 3e 00 00       	call   80104750 <release>
  if(doprocdump) {
...
801008f6:	e8 75 39 00 00       	call   80104270 <wakeup>
...
80100a72:	75 d2                	jne    80100a46 <exec+0x56>
  ...
  if((pgdir = setupkvm()) == 0)
80100a74:	e8 f7 65 00 00       	call   80107070 <setupkvm>
...
80100b04:	e8 b7 63 00 00       	call   80106ec0 <allocuvm>
...
80100b3a:	e8 c1 62 00 00       	call   80106e00 <loaduvm>
...
80100b59:	e8 92 64 00 00       	call   80106ff0 <freevm>
...
80100b95:	e8 26 63 00 00       	call   80106ec0 <allocuvm>
...
80100bac:	e8 3f 64 00 00       	call   80106ff0 <freevm>
...
80100bf1:	e8 1a 65 00 00       	call   80107110 <clearpteu>
  sp = sz;
...
80100c2d:	e8 ae 3d 00 00       	call   801049e0 <strlen>
...
80100c40:	e8 9b 3d 00 00       	call   801049e0 <strlen>
...
80100d00:	e8 9b 3c 00 00       	call   801049a0 <safestrcpy>
...
80100d2c:	e8 3f 5f 00 00       	call   80106c70 <switchuvm>
  freevm(oldpgdir);
80100d31:	89 3c 24             	mov    %edi,(%esp)
80100d34:	e8 b7 62 00 00       	call   80106ff0 <freevm>
  return 0;
...
80100db1:	e8 9a 39 00 00       	call   80104750 <release>
      return f;
...
80100dc8:	e8 83 39 00 00       	call   80104750 <release>
  return 0;
...
80100e0c:	e8 3f 39 00 00       	call   80104750 <release>
  return f;
}
...
80100e6b:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e6c:	e9 df 38 00 00       	jmp    80104750 <release>
...
80100e95:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e98:	e8 b3 38 00 00       	call   80104750 <release>
...
801011e5:	e8 b6 35 00 00       	call   801047a0 <memset>
  log_write(bp);
...
8010122a:	e8 01 34 00 00       	call   80104630 <acquire>
...
8010126f:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101272:	e8 d9 34 00 00       	call   80104750 <release>
      return ip;
...
801012bf:	e8 8c 34 00 00       	call   80104750 <release>
...
8010139a:	68 05 74 10 80       	push   $0x80107405
...
801013d1:	e8 7a 34 00 00       	call   80104850 <memmove>
  brelse(bp);
...
80101466:	68 18 74 10 80       	push   $0x80107418
...
8010147c:	68 2b 74 10 80       	push   $0x8010742b
80101481:	68 e0 09 11 80       	push   $0x801109e0
80101486:	e8 a5 30 00 00       	call   80104530 <initlock>
8010148b:	83 c4 10             	add    $0x10,%esp
8010148e:	66 90                	xchg   %ax,%ax
  for(i = 0; i < NINODE; i++) {
    initsleeplock(&icache.inode[i].lock, "inode");
80101490:	83 ec 08             	sub    $0x8,%esp
80101493:	68 32 74 10 80       	push   $0x80107432
80101498:	53                   	push   %ebx
80101499:	81 c3 90 00 00 00    	add    $0x90,%ebx
8010149f:	e8 7c 2f 00 00       	call   80104420 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
801014e9:	68 98 74 10 80       	push   $0x80107498
...
8010157e:	e8 1d 32 00 00       	call   801047a0 <memset>
      dip->type = type;
...
801015b3:	68 38 74 10 80       	push   $0x80107438
...
80101621:	e8 2a 32 00 00       	call   80104850 <memmove>
  log_write(bp);
...
8010164f:	e8 dc 2f 00 00       	call   80104630 <acquire>
  ip->ref++;
80101654:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101658:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010165f:	e8 ec 30 00 00       	call   80104750 <release>
  return ip;
}
...
80101692:	e8 c9 2d 00 00       	call   80104460 <acquiresleep>
...
80101708:	e8 43 31 00 00       	call   80104850 <memmove>
    brelse(bp);
...
8010172d:	68 50 74 10 80       	push   $0x80107450
...
8010173a:	68 4a 74 10 80       	push   $0x8010744a
...
80101763:	e8 98 2d 00 00       	call   80104500 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
8010177f:	e9 3c 2d 00 00       	jmp    801044c0 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
80101787:	68 5f 74 10 80       	push   $0x8010745f
...
801017b0:	e8 ab 2c 00 00       	call   80104460 <acquiresleep>
...
801017ca:	e8 f1 2c 00 00       	call   801044c0 <releasesleep>

  acquire(&icache.lock);
801017cf:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017d6:	e8 55 2e 00 00       	call   80104630 <acquire>
  ip->ref--;
...
801017ef:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017f0:	e9 5b 2f 00 00       	jmp    80104750 <release>
...
80101800:	e8 2b 2e 00 00       	call   80104630 <acquire>
    int r = ip->ref;
80101805:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
80101808:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010180f:	e8 3c 2f 00 00       	call   80104750 <release>
    if(r == 1){
...
801019f8:	e8 53 2e 00 00       	call   80104850 <memmove>
    brelse(bp);
...
80101af4:	e8 57 2d 00 00       	call   80104850 <memmove>
    log_write(bp);
...
80101b8e:	e8 3d 2d 00 00       	call   801048d0 <strncmp>
}
80101b93:	c9                   	leave  
80101b94:	c3                   	ret    
...
80101bf5:	e8 d6 2c 00 00       	call   801048d0 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101c2d:	68 79 74 10 80       	push   $0x80107479
...
80101c3a:	68 67 74 10 80       	push   $0x80107467
...
80101c79:	e8 b2 29 00 00       	call   80104630 <acquire>
  ip->ref++;
80101c7e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c82:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c89:	e8 c2 2a 00 00       	call   80104750 <release>
...
80101ce5:	e8 66 2b 00 00       	call   80104850 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d74:	e8 d7 2a 00 00       	call   80104850 <memmove>
    name[len] = 0;
...
80101e5d:	e8 de 2a 00 00       	call   80104940 <strncpy>
  de.inum = inum;
...
80101e9b:	68 88 74 10 80       	push   $0x80107488
...
80101fb0:	68 f4 74 10 80       	push   $0x801074f4
...
80101fbd:	68 eb 74 10 80       	push   $0x801074eb
...
80101fd6:	68 06 75 10 80       	push   $0x80107506
80101fdb:	68 80 a5 10 80       	push   $0x8010a580
80101fe0:	e8 4b 25 00 00       	call   80104530 <initlock>
...
8010205e:	e8 cd 25 00 00       	call   80104630 <acquire>
...
8010208e:	e8 dd 21 00 00       	call   80104270 <wakeup>
...
801020ac:	e8 9f 26 00 00       	call   80104750 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020fe:	e8 fd 23 00 00       	call   80104500 <holdingsleep>
...
80102138:	e8 f3 24 00 00       	call   80104630 <acquire>
...
801021a5:	c9                   	leave  
  ...
  release(&idelock);
801021a6:	e9 a5 25 00 00       	jmp    80104750 <release>
...
801021be:	68 0a 75 10 80       	push   $0x8010750a
...
801021cb:	68 35 75 10 80       	push   $0x80107535
...
801021d8:	68 20 75 10 80       	push   $0x80107520
...
8010223a:	68 54 75 10 80       	push   $0x80107554
...
80102312:	e8 89 24 00 00       	call   801047a0 <memset>
...
8010234a:	c9                   	leave  
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
8010234b:	e9 00 24 00 00       	jmp    80104750 <release>
...
80102358:	e8 d3 22 00 00       	call   80104630 <acquire>
...
80102365:	68 86 75 10 80       	push   $0x80107586
...
801023cb:	68 8c 75 10 80       	push   $0x8010758c
801023d0:	68 40 26 11 80       	push   $0x80112640
801023d5:	e8 56 21 00 00       	call   80104530 <initlock>
...
801024be:	e8 8d 22 00 00       	call   80104750 <release>
...
801024d8:	e8 53 21 00 00       	call   80104630 <acquire>
  r = kmem.freelist;
...
80102536:	0f b6 82 c0 76 10 80 	movzbl -0x7fef8940(%edx),%eax
...
8010255e:	0f b6 82 c0 76 10 80 	movzbl -0x7fef8940(%edx),%eax
80102565:	09 c1                	or     %eax,%ecx
80102567:	0f b6 82 c0 75 10 80 	movzbl -0x7fef8a40(%edx),%eax
...
8010257b:	83 e1 08             	and    $0x8,%ecx
  ...
  shift ^= togglecode[data];
  c = charcode[shift & (CTL | SHIFT)][data];
8010257e:	8b 04 85 a0 75 10 80 	mov    -0x7fef8a60(,%eax,4),%eax
...
801028e4:	e8 07 1f 00 00       	call   801047f0 <memcmp>
...
80102a14:	e8 37 1e 00 00       	call   80104850 <memmove>
...
80102aba:	68 c0 77 10 80       	push   $0x801077c0
80102abf:	68 80 26 11 80       	push   $0x80112680
80102ac4:	e8 67 1a 00 00       	call   80104530 <initlock>
  readsb(dev, &sb);
80102ac9:	58                   	pop    %eax
...
80102b5b:	e8 d0 1a 00 00       	call   80104630 <acquire>
...
80102bac:	e8 9f 1b 00 00       	call   80104750 <release>
      break;
    }
  }
}
...
80102bce:	e8 5d 1a 00 00       	call   80104630 <acquire>
  log.outstanding -= 1;
...
80102c0d:	e8 3e 1b 00 00       	call   80104750 <release>
}
...
80102c6c:	e8 df 1b 00 00       	call   80104850 <memmove>
...
80102cb5:	e8 76 19 00 00       	call   80104630 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80102cc8:	00 00 00 
    wakeup(&log);
80102ccb:	e8 a0 15 00 00       	call   80104270 <wakeup>
    release(&log.lock);
80102cd0:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102cd7:	e8 74 1a 00 00       	call   80104750 <release>
...
80102cf8:	e8 73 15 00 00       	call   80104270 <wakeup>
  }
  release(&log.lock);
80102cfd:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d04:	e8 47 1a 00 00       	call   80104750 <release>
...
80102d17:	68 c4 77 10 80       	push   $0x801077c4
...
80102d6e:	e8 bd 18 00 00       	call   80104630 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dbd:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dbe:	e9 8d 19 00 00       	jmp    80104750 <release>
80102dc3:	90                   	nop
...
80102de3:	68 d3 77 10 80       	push   $0x801077d3
80102de8:	e8 83 d5 ff ff       	call   80100370 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102ded:	83 ec 0c             	sub    $0xc,%esp
80102df0:	68 e9 77 10 80       	push   $0x801077e9
...
80102e18:	68 04 78 10 80       	push   $0x80107804
80102e1d:	e8 3e d8 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e22:	e8 e9 2c 00 00       	call   80105b10 <idtinit>
...
80102e43:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e46:	e8 05 3e 00 00       	call   80106c50 <switchkvm>
  seginit();
80102e4b:	e8 00 3d 00 00       	call   80106b50 <seginit>
  lapicinit();
...
80102ea9:	e8 72 2f 00 00       	call   80105e20 <uartinit>
  pinit();         // process table
80102eae:	e8 2d 08 00 00       	call   801036e0 <pinit>
  tvinit();        // trap vectors
80102eb3:	e8 b8 2b 00 00       	call   80105a70 <tvinit>
  binit();         // buffer cache
...
80102ed9:	e8 72 19 00 00       	call   80104850 <memmove>
...
80102fa8:	68 18 78 10 80       	push   $0x80107818
80102fad:	56                   	push   %esi
80102fae:	e8 3d 18 00 00       	call   801047f0 <memcmp>
...
8010306c:	68 1d 78 10 80       	push   $0x8010781d
80103071:	56                   	push   %esi
80103072:	e8 79 17 00 00       	call   801047f0 <memcmp>
...
80103100:	ff 24 95 5c 78 10 80 	jmp    *-0x7fef87a4(,%edx,4)
...
801031a7:	68 22 78 10 80       	push   $0x80107822
...
801031b4:	68 3c 78 10 80       	push   $0x8010783c
...
80103260:	00 00 00 
  initlock(&p->lock, "pipe");
80103263:	68 70 78 10 80       	push   $0x80107870
80103268:	50                   	push   %eax
80103269:	e8 c2 12 00 00       	call   80104530 <initlock>
  (*f0)->type = FD_PIPE;
...
801032ff:	e8 2c 13 00 00       	call   80104630 <acquire>
  if(writable){
...
8010331f:	e8 4c 0f 00 00       	call   80104270 <wakeup>
...
80103343:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103344:	e9 07 14 00 00       	jmp    80104750 <release>
...
80103364:	e8 07 0f 00 00       	call   80104270 <wakeup>
...
80103374:	e8 d7 13 00 00       	call   80104750 <release>
    kfree((char*)p);
...
8010339d:	e8 8e 12 00 00       	call   80104630 <acquire>
  for(i = 0; i < n; i++){
...
801033f0:	e8 7b 0e 00 00       	call   80104270 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801033f5:	58                   	pop    %eax
801033f6:	5a                   	pop    %edx
...
80103424:	e8 27 13 00 00       	call   80104750 <release>
        return -1;
...
80103473:	e8 f8 0d 00 00       	call   80104270 <wakeup>
  release(&p->lock);
80103478:	89 1c 24             	mov    %ebx,(%esp)
8010347b:	e8 d0 12 00 00       	call   80104750 <release>
  return n;
...
801034a0:	e8 8b 11 00 00       	call   80104630 <acquire>
...
80103509:	e8 42 12 00 00       	call   80104750 <release>
      return -1;
...
8010356e:	e8 fd 0c 00 00       	call   80104270 <wakeup>
  release(&p->lock);
80103573:	89 1c 24             	mov    %ebx,(%esp)
80103576:	e8 d5 11 00 00       	call   80104750 <release>
  return i;
...
801035c1:	e8 6a 10 00 00       	call   80104630 <acquire>
...
80103604:	00 00 00 
  p->startpriority = 20;
80103607:	c7 83 50 01 00 00 14 	movl   $0x14,0x150(%ebx)
8010360e:	00 00 00 
  release(&ptable.lock);
  return 0;
...
80103617:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
8010361d:	e8 2e 11 00 00       	call   80104750 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103622:	e8 69 ee ff ff       	call   80102490 <kalloc>
80103627:	83 c4 10             	add    $0x10,%esp
8010362a:	85 c0                	test   %eax,%eax
8010362c:	89 43 08             	mov    %eax,0x8(%ebx)
8010362f:	74 56                	je     80103687 <allocproc+0xd7>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
80103631:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
8010363a:	05 9c 0f 00 00       	add    $0xf9c,%eax
  ...
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
8010363f:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103642:	c7 40 14 59 5a 10 80 	movl   $0x80105a59,0x14(%eax)

  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
80103649:	6a 14                	push   $0x14
8010364b:	6a 00                	push   $0x0
8010364d:	50                   	push   %eax
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
8010364e:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103651:	e8 4a 11 00 00       	call   801047a0 <memset>
  p->context->eip = (uint)forkret;
80103656:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80103659:	83 c4 10             	add    $0x10,%esp
  *(uint*)sp = (uint)trapret;
  ...
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
8010365c:	c7 40 10 90 36 10 80 	movl   $0x80103690,0x10(%eax)

  return p;
80103663:	89 d8                	mov    %ebx,%eax
}
80103665:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103668:	c9                   	leave  
80103669:	c3                   	ret    
...
80103678:	e8 d3 10 00 00       	call   80104750 <release>
  return 0;
...
80103687:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return 0;
8010368e:	eb d5                	jmp    80103665 <allocproc+0xb5>
...
8010369b:	e8 b0 10 00 00       	call   80104750 <release>
...
801036e6:	68 75 78 10 80       	push   $0x80107875
801036eb:	68 20 2d 11 80       	push   $0x80112d20
801036f0:	e8 3b 0e 00 00       	call   80104530 <initlock>
}
...
8010375d:	68 7c 78 10 80       	push   $0x8010787c
...
8010376a:	68 58 79 10 80       	push   $0x80107958
...
801037a4:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
801037a7:	e8 44 0e 00 00       	call   801045f0 <pushcli>
  c = mycpu();
801037ac:	e8 4f ff ff ff       	call   80103700 <mycpu>
  p = c->proc;
801037b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037b7:	e8 24 0f 00 00       	call   801046e0 <popcli>
  return p;
}
...
801037e3:	e8 88 38 00 00       	call   80107070 <setupkvm>
...
80103801:	e8 7a 35 00 00       	call   80106d80 <inituvm>
  p->sz = PGSIZE;
...
8010386f:	68 a5 78 10 80       	push   $0x801078a5
80103874:	50                   	push   %eax
80103875:	e8 26 11 00 00       	call   801049a0 <safestrcpy>
  p->cwd = namei("/");
8010387a:	c7 04 24 ae 78 10 80 	movl   $0x801078ae,(%esp)
...
80103890:	e8 9b 0d 00 00       	call   80104630 <acquire>
...
801038a3:	e8 a8 0e 00 00       	call   80104750 <release>
}
...
801038b3:	68 8c 78 10 80       	push   $0x8010788c
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
801038c8:	e8 23 0d 00 00       	call   801045f0 <pushcli>
  c = mycpu();
801038cd:	e8 2e fe ff ff       	call   80103700 <mycpu>
  p = c->proc;
801038d2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038d8:	e8 03 0e 00 00       	call   801046e0 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
801038ee:	e8 cd 35 00 00       	call   80106ec0 <allocuvm>
...
80103900:	e8 6b 33 00 00       	call   80106c70 <switchuvm>
  return 0;
...
80103924:	e8 97 36 00 00       	call   80106fc0 <deallocuvm>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103949:	e8 a2 0c 00 00       	call   801045f0 <pushcli>
  c = mycpu();
8010394e:	e8 ad fd ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103953:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103959:	e8 82 0d 00 00       	call   801046e0 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
80103978:	e8 c3 37 00 00       	call   80107140 <copyuvm>
...
801039f1:	e8 aa 0f 00 00       	call   801049a0 <safestrcpy>
...
80103a00:	e8 2b 0c 00 00       	call   80104630 <acquire>
...
80103a13:	e8 38 0d 00 00       	call   80104750 <release>
...
80103a70:	8d 40 04             	lea    0x4(%eax),%eax
...
80103adc:	74 5a                	je     80103b38 <scheduler+0xd8>
      if(p->state != RUNNABLE)
...
80103af6:	81 c3 54 01 00 00    	add    $0x154,%ebx
      ...
      if (p->priority == min) {
		  ...
		  c->proc = p;
		  switchuvm(p);
80103afc:	e8 6f 31 00 00       	call   80106c70 <switchuvm>
		  p->state = RUNNING;
...
80103b09:	ff 75 e4             	pushl  -0x1c(%ebp)
      ...
      if (p->priority == min) {
		  ...
		  switchuvm(p);
		  p->state = RUNNING;
80103b0c:	c7 83 b8 fe ff ff 04 	movl   $0x4,-0x148(%ebx)
80103b13:	00 00 00 
		  swtch(&c->scheduler, p->context);
80103b16:	e8 e0 0e 00 00       	call   801049fb <swtch>
		  switchkvm();
80103b1b:	e8 30 31 00 00       	call   80106c50 <switchkvm>
...
80103b40:	e8 0b 0c 00 00       	call   80104750 <release>

  }
80103b45:	83 c4 10             	add    $0x10,%esp
80103b48:	e9 33 ff ff ff       	jmp    80103a80 <scheduler+0x20>
80103b4d:	8d 76 00             	lea    0x0(%esi),%esi

80103b50 <newpriority>:
  yield(); 
  return priority;
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103b58:	e8 93 0a 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80103b5d:	e8 9e fb ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103b62:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b68:	e8 73 0b 00 00       	call   801046e0 <popcli>
}
...
80103b70:	68 20 2d 11 80       	push   $0x80112d20
80103b75:	e8 b6 0a 00 00       	call   80104630 <acquire>
	if(proc->priority < curproc->priority){
80103b7a:	8b 86 4c 01 00 00    	mov    0x14c(%esi),%eax
80103b80:	83 c4 10             	add    $0x10,%esp
80103b83:	3b 83 4c 01 00 00    	cmp    0x14c(%ebx),%eax
80103b89:	7d 06                	jge    80103b91 <newpriority+0x41>
		curproc->priority = proc->priority;
80103b8b:	89 83 4c 01 00 00    	mov    %eax,0x14c(%ebx)
	}
	release(&ptable.lock);
80103b91:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103bb7:	e8 34 0a 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80103bbc:	e8 3f fb ff ff       	call   80103700 <mycpu>
  p = c->proc;
...
80103bcf:	68 20 2d 11 80       	push   $0x80112d20
80103bd4:	e8 57 0a 00 00       	call   80104630 <acquire>
	curproc->priority = curproc->startpriority;
80103bd9:	8b 83 50 01 00 00    	mov    0x150(%ebx),%eax
80103bdf:	89 83 4c 01 00 00    	mov    %eax,0x14c(%ebx)
	release(&ptable.lock);
80103be5:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103bec:	e8 5f 0b 00 00       	call   80104750 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103c05:	e8 e6 09 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80103c0a:	e8 f1 fa ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103c0f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c15:	e8 c6 0a 00 00       	call   801046e0 <popcli>
sched(void)
{
  int intena;
...
80103c47:	75 41                	jne    80103c8a <sched+0x8a>
  ...
  intena = mycpu()->intena;
80103c49:	e8 b2 fa ff ff       	call   80103700 <mycpu>
...
80103c51:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c57:	e8 a4 fa ff ff       	call   80103700 <mycpu>
80103c5c:	83 ec 08             	sub    $0x8,%esp
80103c5f:	ff 70 04             	pushl  0x4(%eax)
80103c62:	53                   	push   %ebx
80103c63:	e8 93 0d 00 00       	call   801049fb <swtch>
  mycpu()->intena = intena;
80103c68:	e8 93 fa ff ff       	call   80103700 <mycpu>
}
...
80103c80:	68 b0 78 10 80       	push   $0x801078b0
80103c85:	e8 e6 c6 ff ff       	call   80100370 <panic>
  if(mycpu()->ncli != 1)
    panic("sched locks");
  if(p->state == RUNNING)
    panic("sched running");
...
80103c8d:	68 dc 78 10 80       	push   $0x801078dc
...
80103c9a:	68 ce 78 10 80       	push   $0x801078ce
...
80103ca7:	68 c2 78 10 80       	push   $0x801078c2
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103cc9:	e8 22 09 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80103cce:	e8 2d fa ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103cd3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cd9:	e8 02 0a 00 00       	call   801046e0 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
  ...
  if(curproc == initproc)
80103cde:	39 1d b8 a5 10 80    	cmp    %ebx,0x8010a5b8
exit(int status)
{
  struct proc *curproc = myproc();
  struct proc *p;
...
80103ce7:	8d 73 28             	lea    0x28(%ebx),%esi
80103cea:	8d 7b 68             	lea    0x68(%ebx),%edi
80103ced:	89 43 7c             	mov    %eax,0x7c(%ebx)
  if(curproc == initproc)
80103cf0:	0f 84 65 01 00 00    	je     80103e5b <exit+0x19b>
    panic("init exiting");
...
80103cfa:	74 12                	je     80103d0e <exit+0x4e>
      fileclose(curproc->ofile[fd]);
80103cfc:	83 ec 0c             	sub    $0xc,%esp
80103cff:	50                   	push   %eax
80103d00:	e8 2b d1 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80103d05:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80103d0b:	83 c4 10             	add    $0x10,%esp
80103d0e:	83 c6 04             	add    $0x4,%esi
  curproc->status = status;
  if(curproc == initproc)
    panic("init exiting");
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80103d11:	39 fe                	cmp    %edi,%esi
80103d13:	75 e1                	jne    80103cf6 <exit+0x36>
      fileclose(curproc->ofile[fd]);
      curproc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80103d15:	e8 36 ee ff ff       	call   80102b50 <begin_op>
  iput(curproc->cwd);
80103d1a:	83 ec 0c             	sub    $0xc,%esp
80103d1d:	ff 73 68             	pushl  0x68(%ebx)
80103d20:	e8 7b da ff ff       	call   801017a0 <iput>
  end_op();
80103d25:	e8 96 ee ff ff       	call   80102bc0 <end_op>
  curproc->cwd = 0;
80103d2a:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)

  acquire(&ptable.lock);
80103d31:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d38:	e8 f3 08 00 00       	call   80104630 <acquire>

  // Parent might be sleeping in wait(0).
  wakeup1(curproc->parent);
80103d3d:	8b 53 14             	mov    0x14(%ebx),%edx
...
80103d48:	eb 12                	jmp    80103d5c <exit+0x9c>
80103d4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103d50:	05 54 01 00 00       	add    $0x154,%eax
80103d55:	3d 54 82 11 80       	cmp    $0x80118254,%eax
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d6e:	05 54 01 00 00       	add    $0x154,%eax
80103d73:	3d 54 82 11 80       	cmp    $0x80118254,%eax
...
80103d84:	7e 5d                	jle    80103de3 <exit+0x123>
...
80103daa:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103daf:	eb 13                	jmp    80103dc4 <exit+0x104>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103db8:	05 54 01 00 00       	add    $0x154,%eax
80103dbd:	3d 54 82 11 80       	cmp    $0x80118254,%eax
80103dc2:	74 cc                	je     80103d90 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan)
80103dc4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103dc8:	75 ee                	jne    80103db8 <exit+0xf8>
80103dca:	39 50 20             	cmp    %edx,0x20(%eax)
80103dcd:	75 e9                	jne    80103db8 <exit+0xf8>
      p->state = RUNNABLE;
80103dcf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103dd6:	eb e0                	jmp    80103db8 <exit+0xf8>
  wakeup1(curproc->parent);
...
80103dee:	eb 0e                	jmp    80103dfe <exit+0x13e>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103df0:	81 c2 54 01 00 00    	add    $0x154,%edx
80103df6:	81 fa 54 82 11 80    	cmp    $0x80118254,%edx
80103dfc:	74 3a                	je     80103e38 <exit+0x178>
    if(p->parent == curproc){
80103dfe:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103e01:	75 ed                	jne    80103df0 <exit+0x130>
      p->parent = initproc;
      if(p->state == ZOMBIE)
...
80103e07:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103e0a:	75 e4                	jne    80103df0 <exit+0x130>
80103e0c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103e11:	eb 11                	jmp    80103e24 <exit+0x164>
80103e13:	90                   	nop
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e18:	05 54 01 00 00       	add    $0x154,%eax
80103e1d:	3d 54 82 11 80       	cmp    $0x80118254,%eax
80103e22:	74 cc                	je     80103df0 <exit+0x130>
    if(p->state == SLEEPING && p->chan == chan)
80103e24:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103e28:	75 ee                	jne    80103e18 <exit+0x158>
80103e2a:	3b 48 20             	cmp    0x20(%eax),%ecx
80103e2d:	75 e9                	jne    80103e18 <exit+0x158>
      p->state = RUNNABLE;
80103e2f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103e36:	eb e0                	jmp    80103e18 <exit+0x158>
        wakeup1(initproc);
    }
  }
  ...
  curproc->priority = 0;
80103e38:	c7 83 4c 01 00 00 00 	movl   $0x0,0x14c(%ebx)
80103e3f:	00 00 00 
  curproc->state = ZOMBIE;
80103e42:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103e49:	e8 b2 fd ff ff       	call   80103c00 <sched>
  panic("zombie exit");
80103e4e:	83 ec 0c             	sub    $0xc,%esp
80103e51:	68 fd 78 10 80       	push   $0x801078fd
80103e56:	e8 15 c5 ff ff       	call   80100370 <panic>
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
  curproc->status = status;
...
80103e5e:	68 f0 78 10 80       	push   $0x801078f0
80103e63:	e8 08 c5 ff ff       	call   80100370 <panic>
80103e68:	90                   	nop
...
80103e7c:	e8 af 07 00 00       	call   80104630 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103e81:	e8 6a 07 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80103e86:	e8 75 f8 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103e8b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e91:	e8 4a 08 00 00       	call   801046e0 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103e96:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103e9d:	e8 5e fd ff ff       	call   80103c00 <sched>
  release(&ptable.lock);
80103ea2:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ea9:	e8 a2 08 00 00       	call   80104750 <release>
}
...
80103ec5:	8b 5d 08             	mov    0x8(%ebp),%ebx
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103ec8:	e8 23 07 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80103ecd:	e8 2e f8 ff ff       	call   80103700 <mycpu>
  p = c->proc;
...
80103ee5:	e8 46 07 00 00       	call   80104630 <acquire>
  if(priority > 63 || priority < 0){
80103eea:	83 c4 10             	add    $0x10,%esp
80103eed:	83 fb 3f             	cmp    $0x3f,%ebx
80103ef0:	77 36                	ja     80103f28 <changepriority+0x68>
    return -1; 
  }
...
80103ef2:	83 ec 0c             	sub    $0xc,%esp
  ...
  curproc->startpriority = priority; 
80103ef5:	89 9e 50 01 00 00    	mov    %ebx,0x150(%esi)
  curproc->priority = priority;
80103efb:	89 9e 4c 01 00 00    	mov    %ebx,0x14c(%esi)
  curproc->state = RUNNABLE;
80103f01:	c7 46 0c 03 00 00 00 	movl   $0x3,0xc(%esi)
  release(&ptable.lock);  
80103f08:	68 20 2d 11 80       	push   $0x80112d20
80103f0d:	e8 3e 08 00 00       	call   80104750 <release>
  //cs153 give up control
  yield(); 
80103f12:	e8 59 ff ff ff       	call   80103e70 <yield>
  return priority;
...
80103f2d:	eb ed                	jmp    80103f1c <changepriority+0x5c>
80103f2f:	90                   	nop
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103f3f:	e8 ac 06 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80103f44:	e8 b7 f7 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103f49:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f4f:	e8 8c 07 00 00       	call   801046e0 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103f80:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  ...
  sched();
80103f87:	e8 74 fc ff ff       	call   80103c00 <sched>
...
80103f9a:	e8 b1 07 00 00       	call   80104750 <release>
    acquire(lk);
...
80103fab:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103fac:	e9 7f 06 00 00       	jmp    80104630 <acquire>
...
80103fbb:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  ...
  sched();
80103fc2:	e8 39 fc ff ff       	call   80103c00 <sched>
...
80103fd9:	68 0f 79 10 80       	push   $0x8010790f
...
80103fe6:	68 09 79 10 80       	push   $0x80107909
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ffc:	e8 ef 05 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80104001:	e8 fa f6 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80104006:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
8010400c:	e8 cf 06 00 00       	call   801046e0 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80104014:	68 20 2d 11 80       	push   $0x80112d20
80104019:	e8 12 06 00 00       	call   80104630 <acquire>
...
80104021:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104023:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104028:	eb 14                	jmp    8010403e <wait+0x4e>
8010402a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104030:	81 c3 54 01 00 00    	add    $0x154,%ebx
80104036:	81 fb 54 82 11 80    	cmp    $0x80118254,%ebx
8010403c:	74 22                	je     80104060 <wait+0x70>
      if(p->parent != curproc)
...
80104047:	74 5c                	je     801040a5 <wait+0xb5>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104049:	81 c3 54 01 00 00    	add    $0x154,%ebx
      if(p->parent != curproc)
        continue;
      havekids = 1;
8010404f:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104054:	81 fb 54 82 11 80    	cmp    $0x80118254,%ebx
...
80104062:	74 1a                	je     8010407e <wait+0x8e>
80104064:	8b 46 24             	mov    0x24(%esi),%eax
80104067:	85 c0                	test   %eax,%eax
80104069:	75 13                	jne    8010407e <wait+0x8e>
      }
      return -1;
    }
...
80104074:	e8 b7 fe ff ff       	call   80103f30 <sleep>
  }
80104079:	83 c4 10             	add    $0x10,%esp
8010407c:	eb a3                	jmp    80104021 <wait+0x31>
      }
    }
...
80104086:	e8 c5 06 00 00       	call   80104750 <release>
      if(status){
8010408b:	83 c4 10             	add    $0x10,%esp
8010408e:	85 ff                	test   %edi,%edi
80104090:	74 77                	je     80104109 <wait+0x119>
	*status = -1;
80104092:	c7 07 ff ff ff ff    	movl   $0xffffffff,(%edi)
      }
      return -1;
...
8010409d:	8d 65 f4             	lea    -0xc(%ebp),%esp
801040a0:	5b                   	pop    %ebx
801040a1:	5e                   	pop    %esi
801040a2:	5f                   	pop    %edi
801040a3:	5d                   	pop    %ebp
...
801040a8:	ff 73 08             	pushl  0x8(%ebx)
      if(p->parent != curproc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
...
801040ab:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801040ae:	e8 2d e2 ff ff       	call   801022e0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
801040b3:	5a                   	pop    %edx
801040b4:	ff 73 04             	pushl  0x4(%ebx)
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
801040b7:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040be:	e8 2d 2f 00 00       	call   80106ff0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
801040c6:	85 ff                	test   %edi,%edi
        ...
        freevm(p->pgdir);
        p->pid = 0;
801040c8:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801040cf:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801040d6:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801040da:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
801040e1:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
	if(status){
801040e8:	74 05                	je     801040ef <wait+0xff>
		*status = p->status;
801040ea:	8b 43 7c             	mov    0x7c(%ebx),%eax
801040ed:	89 07                	mov    %eax,(%edi)
	}
        release(&ptable.lock);
801040ef:	83 ec 0c             	sub    $0xc,%esp
801040f2:	68 20 2d 11 80       	push   $0x80112d20
801040f7:	e8 54 06 00 00       	call   80104750 <release>
        return pid;
...
8010410e:	eb 8d                	jmp    8010409d <wait+0xad>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
8010411f:	e8 cc 04 00 00       	call   801045f0 <pushcli>
  c = mycpu();
80104124:	e8 d7 f5 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80104129:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
8010412f:	e8 ac 05 00 00       	call   801046e0 <popcli>
{
  struct proc *p;
...
8010413c:	e8 ef 04 00 00       	call   80104630 <acquire>
...
8010414e:	eb 0e                	jmp    8010415e <waitpid+0x4e>
80104150:	81 c3 54 01 00 00    	add    $0x154,%ebx
80104156:	81 fb 54 82 11 80    	cmp    $0x80118254,%ebx
8010415c:	74 40                	je     8010419e <waitpid+0x8e>
      if(p->pid != pid) //if the processes PID in ptable != pid argument
8010415e:	8b 73 10             	mov    0x10(%ebx),%esi
80104161:	39 d6                	cmp    %edx,%esi
80104163:	75 eb                	jne    80104150 <waitpid+0x40>
        continue;
      processFound = 1;
      if(p->p_array_sz < sizeof(p->p_array)){ //if there is space in the proccess's wait array, 
80104165:	8b 83 48 01 00 00    	mov    0x148(%ebx),%eax
8010416b:	3d c7 00 00 00       	cmp    $0xc7,%eax
80104170:	77 13                	ja     80104185 <waitpid+0x75>
	p->p_array[p->p_array_sz] = curproc->pid;  //add the proc to the pid process's wait array
80104172:	8b 4f 10             	mov    0x10(%edi),%ecx
80104175:	89 8c 83 80 00 00 00 	mov    %ecx,0x80(%ebx,%eax,4)
	p->p_array_sz++;		
8010417c:	83 c0 01             	add    $0x1,%eax
8010417f:	89 83 48 01 00 00    	mov    %eax,0x148(%ebx)
      }
	
      if(p->state == ZOMBIE){ //if processes p's PID in ptable == pid argument
80104185:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104189:	74 45                	je     801041d0 <waitpid+0xc0>
  ...
  for(;;){
    ...
    // Scan through table looking for exited children.
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010418b:	81 c3 54 01 00 00    	add    $0x154,%ebx
      if(p->pid != pid) //if the processes PID in ptable != pid argument
        continue;
      processFound = 1;
80104191:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    // Scan through table looking for exited children.
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104196:	81 fb 54 82 11 80    	cmp    $0x80118254,%ebx
8010419c:	75 c0                	jne    8010415e <waitpid+0x4e>
        return pidTarget;
      }
    }
...
801041a0:	0f 84 91 00 00 00    	je     80104237 <waitpid+0x127>
801041a6:	8b 4f 24             	mov    0x24(%edi),%ecx
801041a9:	85 c9                	test   %ecx,%ecx
801041ab:	0f 85 86 00 00 00    	jne    80104237 <waitpid+0x127>
      }
      return -1;
    }
...
801041b4:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801041b7:	68 20 2d 11 80       	push   $0x80112d20
801041bc:	57                   	push   %edi
801041bd:	e8 6e fd ff ff       	call   80103f30 <sleep>
  }
801041c2:	83 c4 10             	add    $0x10,%esp
801041c5:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801041c8:	e9 7a ff ff ff       	jmp    80104147 <waitpid+0x37>
...
801041d6:	e8 05 e1 ff ff       	call   801022e0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
801041db:	5f                   	pop    %edi
801041dc:	ff 73 04             	pushl  0x4(%ebx)
      ...
      if(p->state == ZOMBIE){ //if processes p's PID in ptable == pid argument
        ...
        kfree(p->kstack);
        p->kstack = 0;
801041df:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801041e6:	e8 05 2e 00 00       	call   80106ff0 <freevm>
        p->pid = 0;
	p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
        if(status) {
801041eb:	8b 45 0c             	mov    0xc(%ebp),%eax
801041ee:	83 c4 10             	add    $0x10,%esp
        ...
        freevm(p->pgdir);
        p->pid = 0;
801041f1:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
	p->parent = 0;
801041f8:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801041ff:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104203:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010420a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        if(status) {
80104211:	85 c0                	test   %eax,%eax
80104213:	74 08                	je     8010421d <waitpid+0x10d>
	  *status = p->status;
80104215:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104218:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010421b:	89 01                	mov    %eax,(%ecx)
	}
	release(&ptable.lock);
8010421d:	83 ec 0c             	sub    $0xc,%esp
80104220:	68 20 2d 11 80       	push   $0x80112d20
80104225:	e8 26 05 00 00       	call   80104750 <release>
        return pidTarget;
...
80104251:	be ff ff ff ff       	mov    $0xffffffff,%esi
    ...
    if(!processFound || curproc->killed){
      ...
      if(status){
	*status = -1;
80104256:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
    }
...
80104265:	c3                   	ret    
	...
	*status = -1;
      ...
      return -1;
80104266:	be ff ff ff ff       	mov    $0xffffffff,%esi
8010426b:	eb c0                	jmp    8010422d <waitpid+0x11d>
...
8010427f:	e8 ac 03 00 00       	call   80104630 <acquire>
...
80104290:	05 54 01 00 00       	add    $0x154,%eax
80104295:	3d 54 82 11 80       	cmp    $0x80118254,%eax
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042ae:	05 54 01 00 00       	add    $0x154,%eax
801042b3:	3d 54 82 11 80       	cmp    $0x80118254,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
801042ba:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
801042c5:	e9 86 04 00 00       	jmp    80104750 <release>
...
801042df:	e8 4c 03 00 00       	call   80104630 <acquire>
...
801042f0:	05 54 01 00 00       	add    $0x154,%eax
801042f5:	3d 54 82 11 80       	cmp    $0x80118254,%eax
...
80104316:	e8 35 04 00 00       	call   80104750 <release>
      return 0;
...
80104340:	e8 0b 04 00 00       	call   80104750 <release>
  return -1;
...
80104366:	8d 75 e8             	lea    -0x18(%ebp),%esi
...
8010437b:	68 a3 7c 10 80       	push   $0x80107ca3
80104380:	e8 db c2 ff ff       	call   80100660 <cprintf>
80104385:	83 c4 10             	add    $0x10,%esp
80104388:	81 c3 54 01 00 00    	add    $0x154,%ebx
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010438e:	81 fb c0 82 11 80    	cmp    $0x801182c0,%ebx
...
801043a1:	83 f8 05             	cmp    $0x5,%eax
      state = states[p->state];
    else
      state = "???";
801043a4:	ba 20 79 10 80       	mov    $0x80107920,%edx
  uint pc[10];
...
801043ab:	8b 14 85 80 79 10 80 	mov    -0x7fef8680(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801043b2:	b8 20 79 10 80       	mov    $0x80107920,%eax
801043b7:	85 d2                	test   %edx,%edx
801043b9:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801043bc:	53                   	push   %ebx
801043bd:	52                   	push   %edx
801043be:	ff 73 a4             	pushl  -0x5c(%ebx)
801043c1:	68 24 79 10 80       	push   $0x80107924
...
801043d2:	75 a4                	jne    80104378 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801043d4:	8d 45 c0             	lea    -0x40(%ebp),%eax
801043d7:	83 ec 08             	sub    $0x8,%esp
...
801043e8:	e8 63 01 00 00       	call   80104550 <getcallerpcs>
...
801043fd:	68 61 73 10 80       	push   $0x80107361
...
8010442a:	68 98 79 10 80       	push   $0x80107998
8010442f:	8d 43 04             	lea    0x4(%ebx),%eax
80104432:	50                   	push   %eax
80104433:	e8 f8 00 00 00       	call   80104530 <initlock>
  lk->name = name;
...
80104485:	e8 a6 fa ff ff       	call   80103f30 <sleep>
...
80104493:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104499:	e8 02 f3 ff ff       	call   801037a0 <myproc>
...
801044ac:	5d                   	pop    %ebp
  ...
  lk->pid = myproc()->pid;
  release(&lk->lk);
801044ad:	e9 9e 02 00 00       	jmp    80104750 <release>
...
801044cf:	e8 5c 01 00 00       	call   80104630 <acquire>
  lk->locked = 0;
...
801044e4:	e8 87 fd ff ff       	call   80104270 <wakeup>
  release(&lk->lk);
...
801044f4:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
801044f5:	e9 56 02 00 00       	jmp    80104750 <release>
...
8010450b:	8d 5e 04             	lea    0x4(%esi),%ebx
8010450e:	53                   	push   %ebx
8010450f:	e8 1c 01 00 00       	call   80104630 <acquire>
  r = lk->locked;
80104514:	8b 36                	mov    (%esi),%esi
  release(&lk->lk);
80104516:	89 1c 24             	mov    %ebx,(%esp)
80104519:	e8 32 02 00 00       	call   80104750 <release>
  return r;
}
8010451e:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104521:	89 f0                	mov    %esi,%eax
80104523:	5b                   	pop    %ebx
80104524:	5e                   	pop    %esi
80104525:	5d                   	pop    %ebp
80104526:	c3                   	ret    
...
801045b7:	8b 55 08             	mov    0x8(%ebp),%edx
  return lock->locked && lock->cpu == mycpu();
801045ba:	8b 02                	mov    (%edx),%eax
801045bc:	85 c0                	test   %eax,%eax
801045be:	75 10                	jne    801045d0 <holding+0x20>
}
801045c0:	83 c4 04             	add    $0x4,%esp
...
{
  return lock->locked && lock->cpu == mycpu();
801045d0:	8b 5a 08             	mov    0x8(%edx),%ebx
801045d3:	e8 28 f1 ff ff       	call   80103700 <mycpu>
801045d8:	39 c3                	cmp    %eax,%ebx
801045da:	0f 94 c0             	sete   %al
}
801045dd:	83 c4 04             	add    $0x4,%esp
...
{
  return lock->locked && lock->cpu == mycpu();
801045e0:	0f b6 c0             	movzbl %al,%eax
}
801045e3:	5b                   	pop    %ebx
801045e4:	5d                   	pop    %ebp
801045e5:	c3                   	ret    
...
801045f9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801045fa:	e8 01 f1 ff ff       	call   80103700 <mycpu>
...
8010460f:	e8 ec f0 ff ff       	call   80103700 <mycpu>
...
80104635:	e8 b6 ff ff ff       	call   801045f0 <pushcli>
  if(holding(lk))
...
80104641:	75 7d                	jne    801046c0 <acquire+0x90>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104648:	eb 09                	jmp    80104653 <acquire+0x23>
...
8010465a:	75 f4                	jne    80104650 <acquire+0x20>
    ;
...
80104664:	e8 97 f0 ff ff       	call   80103700 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
8010466b:	8d 4b 0c             	lea    0xc(%ebx),%ecx
  // past this point, to ensure that the critical section's memory
  // references happen after the lock is acquired.
  __sync_synchronize();
...
80104674:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104678:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
8010467e:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80104684:	77 1a                	ja     801046a0 <acquire+0x70>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104686:	8b 5a 04             	mov    0x4(%edx),%ebx
80104689:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
{
  uint *ebp;
  int i;
...
8010468f:	8b 12                	mov    (%edx),%edx
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104691:	83 f8 0a             	cmp    $0xa,%eax
80104694:	75 e2                	jne    80104678 <acquire+0x48>
  __sync_synchronize();
...
801046ad:	74 e7                	je     80104696 <acquire+0x66>
    pcs[i] = 0;
801046af:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801046b6:	83 c0 01             	add    $0x1,%eax
801046b9:	83 f8 0a             	cmp    $0xa,%eax
801046bc:	75 e2                	jne    801046a0 <acquire+0x70>
801046be:	eb d6                	jmp    80104696 <acquire+0x66>
...
801046ca:	0f 85 73 ff ff ff    	jne    80104643 <acquire+0x13>
void
acquire(struct spinlock *lk)
{
  pushcli(); // disable interrupts to avoid deadlock.
...
801046d3:	68 a3 79 10 80       	push   $0x801079a3
...
801046eb:	75 52                	jne    8010473f <popcli+0x5f>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
801046ed:	e8 0e f0 ff ff       	call   80103700 <mycpu>
801046f2:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
801046f8:	8d 51 ff             	lea    -0x1(%ecx),%edx
801046fb:	85 d2                	test   %edx,%edx
801046fd:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80104703:	78 2d                	js     80104732 <popcli+0x52>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104705:	e8 f6 ef ff ff       	call   80103700 <mycpu>
8010470a:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80104710:	85 d2                	test   %edx,%edx
80104712:	74 0c                	je     80104720 <popcli+0x40>
    sti();
}
80104714:	c9                   	leave  
80104715:	c3                   	ret    
...
80104719:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104720:	e8 db ef ff ff       	call   80103700 <mycpu>
80104725:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010472b:	85 c0                	test   %eax,%eax
8010472d:	74 e5                	je     80104714 <popcli+0x34>
}
...
80104735:	68 c2 79 10 80       	push   $0x801079c2
...
80104742:	68 ab 79 10 80       	push   $0x801079ab
80104747:	e8 24 bc ff ff       	call   80100370 <panic>
...
8010475c:	75 12                	jne    80104770 <release+0x20>
// Release the lock.
void
release(struct spinlock *lk)
{
...
80104761:	68 c9 79 10 80       	push   $0x801079c9
80104766:	e8 05 bc ff ff       	call   80100370 <panic>
8010476b:	90                   	nop
...
{
  return lock->locked && lock->cpu == mycpu();
80104770:	8b 73 08             	mov    0x8(%ebx),%esi
80104773:	e8 88 ef ff ff       	call   80103700 <mycpu>
80104778:	39 c6                	cmp    %eax,%esi
8010477a:	75 e2                	jne    8010475e <release+0xe>
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
  ...
  lk->pcs[0] = 0;
8010477c:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104783:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  // Tell the C compiler and the processor to not move loads or stores
  ...
  __sync_synchronize();
8010478a:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
...
8010479a:	5d                   	pop    %ebp
  ...
  popcli();
8010479b:	e9 40 ff ff ff       	jmp    801046e0 <popcli>
...
801047a8:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
801047ab:	f6 c2 03             	test   $0x3,%dl
801047ae:	75 05                	jne    801047b5 <memset+0x15>
801047b0:	f6 c1 03             	test   $0x3,%cl
801047b3:	74 13                	je     801047c8 <memset+0x28>
}
...
801047b7:	8b 45 0c             	mov    0xc(%ebp),%eax
801047ba:	fc                   	cld    
801047bb:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
memset(void *dst, int c, uint n)
{
  if ((int)dst%4 == 0 && n%4 == 0){
    c &= 0xFF;
801047c8:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
}
...
801047cc:	c1 e9 02             	shr    $0x2,%ecx
801047cf:	89 fb                	mov    %edi,%ebx
801047d1:	89 f8                	mov    %edi,%eax
801047d3:	c1 e3 18             	shl    $0x18,%ebx
801047d6:	c1 e0 10             	shl    $0x10,%eax
801047d9:	09 d8                	or     %ebx,%eax
801047db:	09 f8                	or     %edi,%eax
801047dd:	c1 e7 08             	shl    $0x8,%edi
801047e0:	09 f8                	or     %edi,%eax
801047e2:	89 d7                	mov    %edx,%edi
801047e4:	fc                   	cld    
801047e5:	f3 ab                	rep stos %eax,%es:(%edi)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
  } else
    stosb(dst, c, n);
  return dst;
...
801047f5:	8b 45 10             	mov    0x10(%ebp),%eax
801047f8:	53                   	push   %ebx
801047f9:	8b 75 0c             	mov    0xc(%ebp),%esi
...
80104801:	74 29                	je     8010482c <memcmp+0x3c>
    if(*s1 != *s2)
80104803:	0f b6 13             	movzbl (%ebx),%edx
80104806:	0f b6 0e             	movzbl (%esi),%ecx
80104809:	38 d1                	cmp    %dl,%cl
8010480b:	75 2b                	jne    80104838 <memcmp+0x48>
8010480d:	8d 78 ff             	lea    -0x1(%eax),%edi
80104810:	31 c0                	xor    %eax,%eax
80104812:	eb 14                	jmp    80104828 <memcmp+0x38>
80104814:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104818:	0f b6 54 03 01       	movzbl 0x1(%ebx,%eax,1),%edx
8010481d:	83 c0 01             	add    $0x1,%eax
80104820:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80104824:	38 ca                	cmp    %cl,%dl
80104826:	75 10                	jne    80104838 <memcmp+0x48>
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
80104828:	39 f8                	cmp    %edi,%eax
8010482a:	75 ec                	jne    80104818 <memcmp+0x28>
      return *s1 - *s2;
    s1++, s2++;
  }
...
80104862:	8d 0c 1e             	lea    (%esi,%ebx,1),%ecx
80104865:	39 c8                	cmp    %ecx,%eax
80104867:	73 27                	jae    80104890 <memmove+0x40>
    s += n;
    d += n;
    while(n-- > 0)
80104869:	85 db                	test   %ebx,%ebx
8010486b:	8d 53 ff             	lea    -0x1(%ebx),%edx
8010486e:	74 17                	je     80104887 <memmove+0x37>
      *--d = *--s;
80104870:	29 d9                	sub    %ebx,%ecx
80104872:	89 cb                	mov    %ecx,%ebx
80104874:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104878:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
8010487c:	88 0c 10             	mov    %cl,(%eax,%edx,1)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
    d += n;
    while(n-- > 0)
8010487f:	83 ea 01             	sub    $0x1,%edx
80104882:	83 fa ff             	cmp    $0xffffffff,%edx
80104885:	75 f1                	jne    80104878 <memmove+0x28>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
8010488c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    while(n-- > 0)
80104890:	31 d2                	xor    %edx,%edx
80104892:	85 db                	test   %ebx,%ebx
80104894:	74 f1                	je     80104887 <memmove+0x37>
...
801048d9:	8b 7d 08             	mov    0x8(%ebp),%edi
801048dc:	8b 75 0c             	mov    0xc(%ebp),%esi
  while(n > 0 && *p && *p == *q)
801048df:	85 c9                	test   %ecx,%ecx
801048e1:	74 37                	je     8010491a <strncmp+0x4a>
801048e3:	0f b6 17             	movzbl (%edi),%edx
801048e6:	0f b6 1e             	movzbl (%esi),%ebx
801048e9:	84 d2                	test   %dl,%dl
801048eb:	74 3f                	je     8010492c <strncmp+0x5c>
801048ed:	38 d3                	cmp    %dl,%bl
801048ef:	75 3b                	jne    8010492c <strncmp+0x5c>
801048f1:	8d 47 01             	lea    0x1(%edi),%eax
801048f4:	01 cf                	add    %ecx,%edi
801048f6:	eb 1b                	jmp    80104913 <strncmp+0x43>
801048f8:	90                   	nop
801048f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104900:	0f b6 10             	movzbl (%eax),%edx
80104903:	84 d2                	test   %dl,%dl
80104905:	74 21                	je     80104928 <strncmp+0x58>
80104907:	0f b6 19             	movzbl (%ecx),%ebx
8010490a:	83 c0 01             	add    $0x1,%eax
8010490d:	89 ce                	mov    %ecx,%esi
8010490f:	38 da                	cmp    %bl,%dl
80104911:	75 19                	jne    8010492c <strncmp+0x5c>
80104913:	39 c7                	cmp    %eax,%edi
    n--, p++, q++;
80104915:	8d 4e 01             	lea    0x1(%esi),%ecx
}
...
{
  while(n > 0 && *p && *p == *q)
80104918:	75 e6                	jne    80104900 <strncmp+0x30>
    n--, p++, q++;
  if(n == 0)
    return 0;
...
80104928:	0f b6 5e 01          	movzbl 0x1(%esi),%ebx
{
  while(n > 0 && *p && *p == *q)
    n--, p++, q++;
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
8010492c:	0f b6 c2             	movzbl %dl,%eax
...
80104a17:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104a1a:	e8 81 ed ff ff       	call   801037a0 <myproc>
...
80104a57:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a5a:	e8 41 ed ff ff       	call   801037a0 <myproc>
...
80104a75:	eb 29                	jmp    80104aa0 <fetchstr+0x50>
...
80104ab5:	e8 e6 ec ff ff       	call   801037a0 <myproc>
...
{
  struct proc *curproc = myproc();
80104ac6:	e8 d5 ec ff ff       	call   801037a0 <myproc>
...
80104b08:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104b0b:	e8 90 ec ff ff       	call   801037a0 <myproc>
...
80104b21:	c1 e8 1f             	shr    $0x1f,%eax
80104b24:	83 c4 10             	add    $0x10,%esp
80104b27:	84 c0                	test   %al,%al
80104b29:	75 2d                	jne    80104b58 <argptr+0x58>
80104b2b:	89 d8                	mov    %ebx,%eax
80104b2d:	c1 e8 1f             	shr    $0x1f,%eax
80104b30:	84 c0                	test   %al,%al
80104b32:	75 24                	jne    80104b58 <argptr+0x58>
80104b34:	8b 16                	mov    (%esi),%edx
80104b36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b39:	39 c2                	cmp    %eax,%edx
80104b3b:	76 1b                	jbe    80104b58 <argptr+0x58>
80104b3d:	01 c3                	add    %eax,%ebx
80104b3f:	39 da                	cmp    %ebx,%edx
80104b41:	72 15                	jb     80104b58 <argptr+0x58>
    return -1;
  *pp = (char*)i;
80104b43:	8b 55 0c             	mov    0xc(%ebp),%edx
80104b46:	89 02                	mov    %eax,(%edx)
  return 0;
80104b48:	31 c0                	xor    %eax,%eax
}
...
80104b5d:	eb eb                	jmp    80104b4a <argptr+0x4a>
80104b5f:	90                   	nop
...
80104b82:	e8 c9 fe ff ff       	call   80104a50 <fetchstr>
...
80104ba5:	e8 f6 eb ff ff       	call   801037a0 <myproc>
  ...
  num = curproc->tf->eax;
80104baa:	8b 70 18             	mov    0x18(%eax),%esi
...
80104bad:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104baf:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104bb2:	8d 50 ff             	lea    -0x1(%eax),%edx
80104bb5:	83 fa 17             	cmp    $0x17,%edx
80104bb8:	77 1e                	ja     80104bd8 <syscall+0x38>
80104bba:	8b 14 85 00 7a 10 80 	mov    -0x7fef8600(,%eax,4),%edx
80104bc1:	85 d2                	test   %edx,%edx
80104bc3:	74 13                	je     80104bd8 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104bc5:	ff d2                	call   *%edx
80104bc7:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104be0:	68 d1 79 10 80       	push   $0x801079d1
...
80104c17:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
80104c1a:	e8 c1 d2 ff ff       	call   80101ee0 <nameiparent>
...
80104c30:	e8 3b ca ff ff       	call   80101670 <ilock>
...
80104c3e:	e8 5d cf ff ff       	call   80101ba0 <dirlookup>
...
80104c58:	e8 13 ca ff ff       	call   80101670 <ilock>
...
80104c84:	e8 77 cc ff ff       	call   80101900 <iunlockput>
    return 0;
...
80104caa:	e8 51 c8 ff ff       	call   80101500 <ialloc>
...
80104cc0:	e8 ab c9 ff ff       	call   80101670 <ilock>
  ip->major = major;
...
80104ce1:	e8 da c8 ff ff       	call   801015c0 <iupdate>
...
80104cf8:	e8 03 d1 ff ff       	call   80101e00 <dirlink>
...
80104d08:	e8 f3 cb ff ff       	call   80101900 <iunlockput>
...
80104d39:	e8 82 c8 ff ff       	call   801015c0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104d3e:	83 c4 0c             	add    $0xc,%esp
80104d41:	ff 73 04             	pushl  0x4(%ebx)
80104d44:	68 80 7a 10 80       	push   $0x80107a80
80104d49:	53                   	push   %ebx
80104d4a:	e8 b1 d0 ff ff       	call   80101e00 <dirlink>
...
80104d5c:	68 7f 7a 10 80       	push   $0x80107a7f
80104d61:	53                   	push   %ebx
80104d62:	e8 99 d0 ff ff       	call   80101e00 <dirlink>
...
80104d71:	68 73 7a 10 80       	push   $0x80107a73
...
80104d7e:	68 82 7a 10 80       	push   $0x80107a82
...
80104d8b:	68 64 7a 10 80       	push   $0x80107a64
...
80104dbc:	78 32                	js     80104df0 <argfd.constprop.0+0x50>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104dbe:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104dc2:	77 2c                	ja     80104df0 <argfd.constprop.0+0x50>
80104dc4:	e8 d7 e9 ff ff       	call   801037a0 <myproc>
80104dc9:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104dcc:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104dd0:	85 c0                	test   %eax,%eax
80104dd2:	74 1c                	je     80104df0 <argfd.constprop.0+0x50>
    return -1;
  if(pfd)
80104dd4:	85 f6                	test   %esi,%esi
80104dd6:	74 02                	je     80104dda <argfd.constprop.0+0x3a>
    *pfd = fd;
80104dd8:	89 16                	mov    %edx,(%esi)
  if(pf)
80104dda:	85 db                	test   %ebx,%ebx
80104ddc:	74 22                	je     80104e00 <argfd.constprop.0+0x60>
    *pf = f;
80104dde:	89 03                	mov    %eax,(%ebx)
  return 0;
...
80104e02:	eb de                	jmp    80104de2 <argfd.constprop.0+0x42>
...
80104e1a:	83 ec 10             	sub    $0x10,%esp
  ...
  if(argfd(0, 0, &f) < 0)
80104e1d:	e8 7e ff ff ff       	call   80104da0 <argfd.constprop.0>
80104e22:	85 c0                	test   %eax,%eax
80104e24:	78 1a                	js     80104e40 <sys_dup+0x30>
...
80104e26:	31 db                	xor    %ebx,%ebx
  ...
  if(argfd(0, 0, &f) < 0)
    return -1;
  if((fd=fdalloc(f)) < 0)
80104e28:	8b 75 f4             	mov    -0xc(%ebp),%esi
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104e2b:	e8 70 e9 ff ff       	call   801037a0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
80104e30:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80104e34:	85 d2                	test   %edx,%edx
80104e36:	74 18                	je     80104e50 <sys_dup+0x40>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
80104e3e:	75 f0                	jne    80104e30 <sys_dup+0x20>
    return -1;
  if((fd=fdalloc(f)) < 0)
    return -1;
  filedup(f);
...
80104e5a:	e8 81 bf ff ff       	call   80100de0 <filedup>
  return fd;
...
80104e7b:	e8 20 ff ff ff       	call   80104da0 <argfd.constprop.0>
...
80104e8d:	e8 1e fc ff ff       	call   80104ab0 <argint>
...
80104ea5:	e8 56 fc ff ff       	call   80104b00 <argptr>
...
80104ebd:	e8 8e c0 ff ff       	call   80100f50 <fileread>
...
80104eeb:	e8 b0 fe ff ff       	call   80104da0 <argfd.constprop.0>
...
80104efd:	e8 ae fb ff ff       	call   80104ab0 <argint>
...
80104f15:	e8 e6 fb ff ff       	call   80104b00 <argptr>
...
80104f2d:	e8 ae c0 ff ff       	call   80100fe0 <filewrite>
...
80104f5c:	e8 3f fe ff ff       	call   80104da0 <argfd.constprop.0>
80104f61:	85 c0                	test   %eax,%eax
80104f63:	78 2b                	js     80104f90 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104f65:	e8 36 e8 ff ff       	call   801037a0 <myproc>
...
80104fab:	e8 f0 fd ff ff       	call   80104da0 <argfd.constprop.0>
...
80104fbf:	e8 3c fb ff ff       	call   80104b00 <argptr>
...
80104fd4:	e8 27 bf ff ff       	call   80100f00 <filestat>
...
80104fff:	e8 5c fb ff ff       	call   80104b60 <argstr>
...
80105018:	e8 43 fb ff ff       	call   80104b60 <argstr>
...
80105033:	e8 88 ce ff ff       	call   80101ec0 <namei>
80105038:	83 c4 10             	add    $0x10,%esp
8010503b:	85 c0                	test   %eax,%eax
8010503d:	89 c3                	mov    %eax,%ebx
8010503f:	0f 84 f3 00 00 00    	je     80105138 <sys_link+0x148>
    end_op();
    return -1;
  }
...
80105049:	e8 22 c6 ff ff       	call   80101670 <ilock>
  if(ip->type == T_DIR){
8010504e:	83 c4 10             	add    $0x10,%esp
80105051:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105056:	0f 84 c4 00 00 00    	je     80105120 <sys_link+0x130>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80105068:	e8 53 c5 ff ff       	call   801015c0 <iupdate>
  iunlock(ip);
8010506d:	89 1c 24             	mov    %ebx,(%esp)
80105070:	e8 db c6 ff ff       	call   80101750 <iunlock>
...
8010507b:	e8 60 ce ff ff       	call   80101ee0 <nameiparent>
...
8010508d:	e8 de c5 ff ff       	call   80101670 <ilock>
...
801050a3:	e8 58 cd ff ff       	call   80101e00 <dirlink>
...
801050b3:	e8 48 c8 ff ff       	call   80101900 <iunlockput>
  iput(ip);
801050b8:	89 1c 24             	mov    %ebx,(%esp)
801050bb:	e8 e0 c6 ff ff       	call   801017a0 <iput>

  end_op();
801050c0:	e8 fb da ff ff       	call   80102bc0 <end_op>
...
801050dc:	e8 1f c8 ff ff       	call   80101900 <iunlockput>
    goto bad;
...
801050f5:	e8 c6 c4 ff ff       	call   801015c0 <iupdate>
  iunlockput(ip);
801050fa:	89 1c 24             	mov    %ebx,(%esp)
801050fd:	e8 fe c7 ff ff       	call   80101900 <iunlockput>
  end_op();
80105102:	e8 b9 da ff ff       	call   80102bc0 <end_op>
  return -1;
...
80105124:	e8 d7 c7 ff ff       	call   80101900 <iunlockput>
    end_op();
80105129:	e8 92 da ff ff       	call   80102bc0 <end_op>
    return -1;
8010512e:	83 c4 10             	add    $0x10,%esp
80105131:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105136:	eb 92                	jmp    801050ca <sys_link+0xda>
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
    return -1;
  ...
  if((ip = namei(old)) == 0){
    end_op();
80105138:	e8 83 da ff ff       	call   80102bc0 <end_op>
    return -1;
8010513d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105142:	eb 86                	jmp    801050ca <sys_link+0xda>
...
8010515f:	e8 fc f9 ff ff       	call   80104b60 <argstr>
80105164:	83 c4 10             	add    $0x10,%esp
80105167:	85 c0                	test   %eax,%eax
80105169:	0f 88 82 01 00 00    	js     801052f1 <sys_unlink+0x1a1>
    return -1;
...
8010516f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80105172:	e8 d9 d9 ff ff       	call   80102b50 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105177:	83 ec 08             	sub    $0x8,%esp
8010517a:	53                   	push   %ebx
8010517b:	ff 75 c0             	pushl  -0x40(%ebp)
8010517e:	e8 5d cd ff ff       	call   80101ee0 <nameiparent>
80105183:	83 c4 10             	add    $0x10,%esp
80105186:	85 c0                	test   %eax,%eax
80105188:	89 45 b4             	mov    %eax,-0x4c(%ebp)
8010518b:	0f 84 6a 01 00 00    	je     801052fb <sys_unlink+0x1ab>
    end_op();
    return -1;
  }

  ilock(dp);
80105191:	8b 75 b4             	mov    -0x4c(%ebp),%esi
80105194:	83 ec 0c             	sub    $0xc,%esp
80105197:	56                   	push   %esi
80105198:	e8 d3 c4 ff ff       	call   80101670 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010519d:	58                   	pop    %eax
8010519e:	5a                   	pop    %edx
8010519f:	68 80 7a 10 80       	push   $0x80107a80
801051a4:	53                   	push   %ebx
801051a5:	e8 d6 c9 ff ff       	call   80101b80 <namecmp>
801051aa:	83 c4 10             	add    $0x10,%esp
801051ad:	85 c0                	test   %eax,%eax
801051af:	0f 84 fc 00 00 00    	je     801052b1 <sys_unlink+0x161>
801051b5:	83 ec 08             	sub    $0x8,%esp
801051b8:	68 7f 7a 10 80       	push   $0x80107a7f
801051bd:	53                   	push   %ebx
801051be:	e8 bd c9 ff ff       	call   80101b80 <namecmp>
801051c3:	83 c4 10             	add    $0x10,%esp
801051c6:	85 c0                	test   %eax,%eax
801051c8:	0f 84 e3 00 00 00    	je     801052b1 <sys_unlink+0x161>
    goto bad;
...
80105220:	e8 2b c8 ff ff       	call   80101a50 <writei>
80105225:	83 c4 20             	add    $0x20,%esp
80105228:	83 f8 10             	cmp    $0x10,%eax
8010522b:	0f 85 e6 00 00 00    	jne    80105317 <sys_unlink+0x1c7>
    panic("unlink: writei");
  if(ip->type == T_DIR){
80105231:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105236:	0f 84 9c 00 00 00    	je     801052d8 <sys_unlink+0x188>
    dp->nlink--;
    iupdate(dp);
  }
  iunlockput(dp);
...
80105242:	e8 b9 c6 ff ff       	call   80101900 <iunlockput>

  ip->nlink--;
80105247:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010524c:	89 1c 24             	mov    %ebx,(%esp)
8010524f:	e8 6c c3 ff ff       	call   801015c0 <iupdate>
  iunlockput(ip);
80105254:	89 1c 24             	mov    %ebx,(%esp)
80105257:	e8 a4 c6 ff ff       	call   80101900 <iunlockput>

  end_op();
8010525c:	e8 5f d9 ff ff       	call   80102bc0 <end_op>
...
80105286:	0f 83 7e ff ff ff    	jae    8010520a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010528c:	6a 10                	push   $0x10
8010528e:	57                   	push   %edi
8010528f:	56                   	push   %esi
80105290:	53                   	push   %ebx
80105291:	e8 ba c6 ff ff       	call   80101950 <readi>
80105296:	83 c4 10             	add    $0x10,%esp
80105299:	83 f8 10             	cmp    $0x10,%eax
8010529c:	75 6c                	jne    8010530a <sys_unlink+0x1ba>
      panic("isdirempty: readi");
    if(de.inum != 0)
8010529e:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801052a3:	74 db                	je     80105280 <sys_unlink+0x130>
  ilock(ip);
...
801052a9:	e8 52 c6 ff ff       	call   80101900 <iunlockput>
    goto bad;
...
801052b4:	ff 75 b4             	pushl  -0x4c(%ebp)
801052b7:	e8 44 c6 ff ff       	call   80101900 <iunlockput>
  end_op();
801052bc:	e8 ff d8 ff ff       	call   80102bc0 <end_op>
  return -1;
...
801052d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(ip->type == T_DIR){
    dp->nlink--;
801052d8:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
801052db:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(ip->type == T_DIR){
    dp->nlink--;
801052de:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
801052e3:	50                   	push   %eax
801052e4:	e8 d7 c2 ff ff       	call   801015c0 <iupdate>
801052e9:	83 c4 10             	add    $0x10,%esp
801052ec:	e9 4b ff ff ff       	jmp    8010523c <sys_unlink+0xec>
  struct dirent de;
  char name[DIRSIZ], *path;
  uint off;
...
801052f6:	e9 6b ff ff ff       	jmp    80105266 <sys_unlink+0x116>

  begin_op();
  if((dp = nameiparent(path, name)) == 0){
    end_op();
801052fb:	e8 c0 d8 ff ff       	call   80102bc0 <end_op>
    return -1;
80105300:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105305:	e9 5c ff ff ff       	jmp    80105266 <sys_unlink+0x116>
  int off;
  struct dirent de;
...
8010530d:	68 a4 7a 10 80       	push   $0x80107aa4
80105312:	e8 59 b0 ff ff       	call   80100370 <panic>
    goto bad;
  }
...
8010531a:	68 b6 7a 10 80       	push   $0x80107ab6
8010531f:	e8 4c b0 ff ff       	call   80100370 <panic>
  if((ip = dirlookup(dp, name, &off)) == 0)
    goto bad;
  ilock(ip);
...
80105327:	68 92 7a 10 80       	push   $0x80107a92
8010532c:	e8 3f b0 ff ff       	call   80100370 <panic>
80105331:	eb 0d                	jmp    80105340 <sys_open>
80105333:	90                   	nop
80105334:	90                   	nop
80105335:	90                   	nop
80105336:	90                   	nop
...
80105346:	8d 45 e0             	lea    -0x20(%ebp),%eax
  return ip;
}
...
8010534f:	e8 0c f8 ff ff       	call   80104b60 <argstr>
80105354:	83 c4 10             	add    $0x10,%esp
80105357:	85 c0                	test   %eax,%eax
80105359:	0f 88 9e 00 00 00    	js     801053fd <sys_open+0xbd>
8010535f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
...
80105372:	0f 88 85 00 00 00    	js     801053fd <sys_open+0xbd>
    return -1;

  begin_op();
80105378:	e8 d3 d7 ff ff       	call   80102b50 <begin_op>

  if(omode & O_CREATE){
8010537d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105381:	0f 85 89 00 00 00    	jne    80105410 <sys_open+0xd0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
8010538a:	ff 75 e0             	pushl  -0x20(%ebp)
8010538d:	e8 2e cb ff ff       	call   80101ec0 <namei>
80105392:	83 c4 10             	add    $0x10,%esp
80105395:	85 c0                	test   %eax,%eax
80105397:	89 c6                	mov    %eax,%esi
80105399:	0f 84 8e 00 00 00    	je     8010542d <sys_open+0xed>
      end_op();
      return -1;
    }
    ilock(ip);
...
801053a3:	e8 c8 c2 ff ff       	call   80101670 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801053a8:	83 c4 10             	add    $0x10,%esp
801053ab:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801053b0:	0f 84 d2 00 00 00    	je     80105488 <sys_open+0x148>
      end_op();
      return -1;
    }
  }
...
801053b6:	e8 b5 b9 ff ff       	call   80100d70 <filealloc>
801053bb:	85 c0                	test   %eax,%eax
801053bd:	89 c7                	mov    %eax,%edi
801053bf:	74 2b                	je     801053ec <sys_open+0xac>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801053c3:	e8 d8 e3 ff ff       	call   801037a0 <myproc>
801053c8:	90                   	nop
...
801053d6:	74 68                	je     80105440 <sys_open+0x100>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
801053de:	75 f0                	jne    801053d0 <sys_open+0x90>
    }
  }
...
801053e4:	e8 47 ba ff ff       	call   80100e30 <fileclose>
801053e9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801053ec:	83 ec 0c             	sub    $0xc,%esp
801053ef:	56                   	push   %esi
801053f0:	e8 0b c5 ff ff       	call   80101900 <iunlockput>
    end_op();
801053f5:	e8 c6 d7 ff ff       	call   80102bc0 <end_op>
    return -1;
...
8010541f:	e8 dc f7 ff ff       	call   80104c00 <create>
    if(ip == 0){
...
80105429:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010542b:	75 89                	jne    801053b6 <sys_open+0x76>
      end_op();
8010542d:	e8 8e d7 ff ff       	call   80102bc0 <end_op>
      return -1;
80105432:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105437:	eb 43                	jmp    8010547c <sys_open+0x13c>
...
80105448:	e8 03 c3 ff ff       	call   80101750 <iunlock>
  end_op();
...
8010545e:	89 77 10             	mov    %esi,0x10(%edi)
  f->off = 0;
80105461:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80105468:	89 d0                	mov    %edx,%eax
8010546a:	83 e0 01             	and    $0x1,%eax
8010546d:	83 f0 01             	xor    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105470:	83 e2 03             	and    $0x3,%edx
  end_op();
  ...
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105473:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105476:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
...
8010548d:	0f 84 23 ff ff ff    	je     801053b6 <sys_open+0x76>
80105493:	e9 54 ff ff ff       	jmp    801053ec <sys_open+0xac>
80105498:	90                   	nop
...
801054ca:	ba 01 00 00 00       	mov    $0x1,%edx
801054cf:	e8 2c f7 ff ff       	call   80104c00 <create>
...
801054df:	e8 1c c4 ff ff       	call   80101900 <iunlockput>
  end_op();
801054e4:	e8 d7 d6 ff ff       	call   80102bc0 <end_op>
  return 0;
...
80105529:	e8 82 f5 ff ff       	call   80104ab0 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
8010553e:	e8 6d f5 ff ff       	call   80104ab0 <argint>
  char *path;
  int major, minor;
...
8010555e:	e8 9d f6 ff ff       	call   80104c00 <create>
...
8010556e:	e8 8d c3 ff ff       	call   80101900 <iunlockput>
  end_op();
80105573:	e8 48 d6 ff ff       	call   80102bc0 <end_op>
  return 0;
...
801055bf:	e8 fc c8 ff ff       	call   80101ec0 <namei>
801055c4:	83 c4 10             	add    $0x10,%esp
801055c7:	85 c0                	test   %eax,%eax
801055c9:	89 c3                	mov    %eax,%ebx
...
801055d1:	e8 9a c0 ff ff       	call   80101670 <ilock>
  if(ip->type != T_DIR){
...
801055e4:	e8 67 c1 ff ff       	call   80101750 <iunlock>
  iput(curproc->cwd);
801055e9:	58                   	pop    %eax
801055ea:	ff 76 68             	pushl  0x68(%esi)
801055ed:	e8 ae c1 ff ff       	call   801017a0 <iput>
  end_op();
801055f2:	e8 c9 d5 ff ff       	call   80102bc0 <end_op>
  curproc->cwd = ip;
...
80105614:	e8 e7 c2 ff ff       	call   80101900 <iunlockput>
    end_op();
80105619:	e8 a2 d5 ff ff       	call   80102bc0 <end_op>
    return -1;
...
80105646:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
  return 0;
}
...
80105655:	e8 06 f5 ff ff       	call   80104b60 <argstr>
8010565a:	83 c4 10             	add    $0x10,%esp
8010565d:	85 c0                	test   %eax,%eax
8010565f:	78 7f                	js     801056e0 <sys_exec+0xa0>
80105661:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105667:	83 ec 08             	sub    $0x8,%esp
8010566a:	50                   	push   %eax
8010566b:	6a 01                	push   $0x1
8010566d:	e8 3e f4 ff ff       	call   80104ab0 <argint>
80105672:	83 c4 10             	add    $0x10,%esp
80105675:	85 c0                	test   %eax,%eax
80105677:	78 67                	js     801056e0 <sys_exec+0xa0>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105679:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
8010567f:	83 ec 04             	sub    $0x4,%esp
80105682:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
80105688:	68 80 00 00 00       	push   $0x80
8010568d:	6a 00                	push   $0x0
8010568f:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105695:	50                   	push   %eax
80105696:	31 db                	xor    %ebx,%ebx
80105698:	e8 03 f1 ff ff       	call   801047a0 <memset>
8010569d:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801056a0:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801056a6:	83 ec 08             	sub    $0x8,%esp
801056a9:	57                   	push   %edi
801056aa:	8d 04 98             	lea    (%eax,%ebx,4),%eax
801056ad:	50                   	push   %eax
801056ae:	e8 5d f3 ff ff       	call   80104a10 <fetchint>
801056b3:	83 c4 10             	add    $0x10,%esp
801056b6:	85 c0                	test   %eax,%eax
801056b8:	78 26                	js     801056e0 <sys_exec+0xa0>
      return -1;
    if(uarg == 0){
801056ba:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801056c0:	85 c0                	test   %eax,%eax
801056c2:	74 2c                	je     801056f0 <sys_exec+0xb0>
      argv[i] = 0;
      break;
    }
...
801056c9:	e8 82 f3 ff ff       	call   80104a50 <fetchstr>
801056ce:	83 c4 10             	add    $0x10,%esp
801056d1:	85 c0                	test   %eax,%eax
801056d3:	78 0b                	js     801056e0 <sys_exec+0xa0>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801056d5:	83 c3 01             	add    $0x1,%ebx
801056d8:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
801056db:	83 fb 20             	cmp    $0x20,%ebx
801056de:	75 c0                	jne    801056a0 <sys_exec+0x60>
    }
    if(fetchstr(uarg, &argv[i]) < 0)
      return -1;
  }
...
8010570b:	e8 e0 b2 ff ff       	call   801009f0 <exec>
...
80105756:	8b 7d e0             	mov    -0x20(%ebp),%edi
// Takes over file reference from caller on success.
static int
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105759:	e8 42 e0 ff ff       	call   801037a0 <myproc>
...
80105766:	74 30                	je     80105798 <sys_pipe+0x78>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
80105776:	e8 b5 b6 ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
8010577b:	58                   	pop    %eax
8010577c:	ff 75 e4             	pushl  -0x1c(%ebp)
8010577f:	e8 ac b6 ff ff       	call   80100e30 <fileclose>
    return -1;
...
80105787:	8d 65 f4             	lea    -0xc(%ebp),%esp
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
...
80105794:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
80105798:	8d 73 08             	lea    0x8(%ebx),%esi
8010579b:	89 7c b0 08          	mov    %edi,0x8(%eax,%esi,4)
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
    return -1;
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010579f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
// Takes over file reference from caller on success.
static int
fdalloc(struct file *f)
{
...
801057a2:	e8 f9 df ff ff       	call   801037a0 <myproc>
  ...
  for(fd = 0; fd < NOFILE; fd++){
801057a7:	31 d2                	xor    %edx,%edx
801057a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
801057b0:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
801057b4:	85 c9                	test   %ecx,%ecx
801057b6:	74 18                	je     801057d0 <sys_pipe+0xb0>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
801057be:	75 f0                	jne    801057b0 <sys_pipe+0x90>
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
...
801057c5:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
801057cc:	00 
801057cd:	eb a1                	jmp    80105770 <sys_pipe+0x50>
801057cf:	90                   	nop
  int fd;
  struct proc *curproc = myproc();
...
{
  return fork();
801057f4:	e9 47 e1 ff ff       	jmp    80103940 <fork>
...
8010580c:	e8 9f f2 ff ff       	call   80104ab0 <argint>
  exit(status);
80105811:	58                   	pop    %eax
80105812:	ff 75 f4             	pushl  -0xc(%ebp)
80105815:	e8 a6 e4 ff ff       	call   80103cc0 <exit>
...
8010582e:	e8 cd f2 ff ff       	call   80104b00 <argptr>
  return wait(status);
80105833:	58                   	pop    %eax
80105834:	ff 75 f4             	pushl  -0xc(%ebp)
80105837:	e8 b4 e7 ff ff       	call   80103ff0 <wait>
}
8010583c:	c9                   	leave  
8010583d:	c3                   	ret    
8010583e:	66 90                	xchg   %ax,%ax

80105840 <sys_changepriority>:
...
8010584c:	e8 5f f2 ff ff       	call   80104ab0 <argint>
  changepriority(priority);
80105851:	58                   	pop    %eax
80105852:	ff 75 f4             	pushl  -0xc(%ebp)
80105855:	e8 66 e6 ff ff       	call   80103ec0 <changepriority>
  return priority;
}
...
80105866:	e8 35 df ff ff       	call   801037a0 <myproc>
8010586b:	8b 80 4c 01 00 00    	mov    0x14c(%eax),%eax
}
80105871:	c9                   	leave  
80105872:	c3                   	ret    
80105873:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
8010588c:	e8 1f f2 ff ff       	call   80104ab0 <argint>
...
8010589e:	e8 2d ea ff ff       	call   801042d0 <kill>
...
801058c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058c6:	e8 d5 de ff ff       	call   801037a0 <myproc>
...
801058dd:	e8 ce f1 ff ff       	call   80104ab0 <argint>
...
801058f6:	e8 c5 df ff ff       	call   801038c0 <growproc>
...
8010592d:	e8 7e f1 ff ff       	call   80104ab0 <argint>
...
80105940:	68 60 82 11 80       	push   $0x80118260
80105945:	e8 e6 ec ff ff       	call   80104630 <acquire>
  ticks0 = ticks;
...
8010594d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105950:	8b 1d a0 8a 11 80    	mov    0x80118aa0,%ebx
  while(ticks - ticks0 < n){
...
80105963:	68 60 82 11 80       	push   $0x80118260
80105968:	68 a0 8a 11 80       	push   $0x80118aa0
8010596d:	e8 be e5 ff ff       	call   80103f30 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105972:	a1 a0 8a 11 80       	mov    0x80118aa0,%eax
...
8010597f:	73 2f                	jae    801059b0 <sys_sleep+0x90>
    if(myproc()->killed){
80105981:	e8 1a de ff ff       	call   801037a0 <myproc>
...
80105990:	68 60 82 11 80       	push   $0x80118260
80105995:	e8 b6 ed ff ff       	call   80104750 <release>
      return -1;
...
801059b3:	68 60 82 11 80       	push   $0x80118260
801059b8:	e8 93 ed ff ff       	call   80104750 <release>
  return 0;
...
801059d4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059d7:	68 60 82 11 80       	push   $0x80118260
801059dc:	e8 4f ec ff ff       	call   80104630 <acquire>
  xticks = ticks;
801059e1:	8b 1d a0 8a 11 80    	mov    0x80118aa0,%ebx
  release(&tickslock);
801059e7:	c7 04 24 60 82 11 80 	movl   $0x80118260,(%esp)
801059ee:	e8 5d ed ff ff       	call   80104750 <release>
  return xticks;
}
...
80105a03:	83 ec 20             	sub    $0x20,%esp
  ...
  argint(0, &pid);
80105a06:	8d 45 ec             	lea    -0x14(%ebp),%eax
...
80105a29:	e8 82 f0 ff ff       	call   80104ab0 <argint>
  return waitpid(pid, status, options);
80105a2e:	83 c4 0c             	add    $0xc,%esp
80105a31:	ff 75 f0             	pushl  -0x10(%ebp)
80105a34:	ff 75 f4             	pushl  -0xc(%ebp)
80105a37:	ff 75 ec             	pushl  -0x14(%ebp)
80105a3a:	e8 d1 e6 ff ff       	call   80104110 <waitpid>
  return 0;
}
80105a3f:	c9                   	leave  
80105a40:	c3                   	ret    
...
80105a42:	06                   	push   %es
  pushl %fs
80105a43:	0f a0                	push   %fs
  pushl %gs
80105a45:	0f a8                	push   %gs
  pushal
80105a47:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a48:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a4c:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a4e:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a50:	54                   	push   %esp
  call trap
80105a51:	e8 ea 00 00 00       	call   80105b40 <trap>
  addl $4, %esp
80105a56:	83 c4 04             	add    $0x4,%esp
...
80105a59:	61                   	popa   
  popl %gs
80105a5a:	0f a9                	pop    %gs
  popl %fs
80105a5c:	0f a1                	pop    %fs
  popl %es
80105a5e:	07                   	pop    %es
  popl %ds
80105a5f:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105a60:	83 c4 08             	add    $0x8,%esp
  iret
80105a63:	cf                   	iret   
...
80105a84:	c6 04 c5 a4 82 11 80 	movb   $0x0,-0x7fee7d5c(,%eax,8)
80105a8b:	00 
80105a8c:	66 89 0c c5 a2 82 11 	mov    %cx,-0x7fee7d5e(,%eax,8)
80105a93:	80 
80105a94:	c6 04 c5 a5 82 11 80 	movb   $0x8e,-0x7fee7d5b(,%eax,8)
80105a9b:	8e 
80105a9c:	66 89 14 c5 a0 82 11 	mov    %dx,-0x7fee7d60(,%eax,8)
80105aa3:	80 
80105aa4:	c1 ea 10             	shr    $0x10,%edx
80105aa7:	66 89 14 c5 a6 82 11 	mov    %dx,-0x7fee7d5a(,%eax,8)
80105aae:	80 
void
tvinit(void)
{
...
80105ac9:	68 c5 7a 10 80       	push   $0x80107ac5
80105ace:	68 60 82 11 80       	push   $0x80118260
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ad3:	66 89 15 a2 84 11 80 	mov    %dx,0x801184a2
80105ada:	c6 05 a4 84 11 80 00 	movb   $0x0,0x801184a4
80105ae1:	66 a3 a0 84 11 80    	mov    %ax,0x801184a0
80105ae7:	c1 e8 10             	shr    $0x10,%eax
80105aea:	c6 05 a5 84 11 80 ef 	movb   $0xef,0x801184a5
80105af1:	66 a3 a6 84 11 80    	mov    %ax,0x801184a6

  initlock(&tickslock, "time");
80105af7:	e8 34 ea ff ff       	call   80104530 <initlock>
}
...
80105b1b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b1f:	b8 a0 82 11 80       	mov    $0x801182a0,%eax
...
80105b52:	0f 84 98 01 00 00    	je     80105cf0 <trap+0x1b0>
    if(myproc()->killed)
      exit(0);
    return;
  }
...
80105b60:	ff 24 85 6c 7b 10 80 	jmp    *-0x7fef8494(,%eax,4)
...
80105b77:	0f 84 f7 01 00 00    	je     80105d74 <trap+0x234>
80105b7d:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105b81:	0f 84 ed 01 00 00    	je     80105d74 <trap+0x234>
...
80105bc5:	68 28 7b 10 80       	push   $0x80107b28
...
80105bd2:	e8 c9 db ff ff       	call   801037a0 <myproc>
...
80105be0:	e8 bb db ff ff       	call   801037a0 <myproc>
80105be5:	85 c0                	test   %eax,%eax
80105be7:	74 0c                	je     80105bf5 <trap+0xb5>
80105be9:	e8 b2 db ff ff       	call   801037a0 <myproc>
...
80105bf5:	e8 a6 db ff ff       	call   801037a0 <myproc>
80105bfa:	85 c0                	test   %eax,%eax
80105bfc:	74 0b                	je     80105c09 <trap+0xc9>
80105bfe:	e8 9d db ff ff       	call   801037a0 <myproc>
80105c03:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105c07:	74 57                	je     80105c60 <trap+0x120>
...
80105c12:	e8 89 db ff ff       	call   801037a0 <myproc>
...
80105c29:	0f 84 ea 00 00 00    	je     80105d19 <trap+0x1d9>
    exit(0);
}
...
80105c52:	e8 69 e0 ff ff       	call   80103cc0 <exit>
80105c57:	83 c4 10             	add    $0x10,%esp
80105c5a:	eb 99                	jmp    80105bf5 <trap+0xb5>
...
80105c64:	75 a3                	jne    80105c09 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105c66:	e8 05 e2 ff ff       	call   80103e70 <yield>
80105c6b:	eb 9c                	jmp    80105c09 <trap+0xc9>
80105c6d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105c70:	e8 0b db ff ff       	call   80103780 <cpuid>
80105c75:	85 c0                	test   %eax,%eax
80105c77:	0f 84 c3 00 00 00    	je     80105d40 <trap+0x200>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105c7d:	e8 8e ca ff ff       	call   80102710 <lapiceoi>
    break;
80105c82:	e9 59 ff ff ff       	jmp    80105be0 <trap+0xa0>
...
80105c89:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105c90:	e8 3b c9 ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
80105c95:	e8 76 ca ff ff       	call   80102710 <lapiceoi>
    break;
80105c9a:	e9 41 ff ff ff       	jmp    80105be0 <trap+0xa0>
80105c9f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105ca0:	e8 6b 02 00 00       	call   80105f10 <uartintr>
    lapiceoi();
80105ca5:	e8 66 ca ff ff       	call   80102710 <lapiceoi>
    break;
80105caa:	e9 31 ff ff ff       	jmp    80105be0 <trap+0xa0>
80105caf:	90                   	nop
  case T_IRQ0 + 7:
...
80105cb7:	e8 c4 da ff ff       	call   80103780 <cpuid>
80105cbc:	56                   	push   %esi
80105cbd:	53                   	push   %ebx
80105cbe:	50                   	push   %eax
80105cbf:	68 d0 7a 10 80       	push   $0x80107ad0
80105cc4:	e8 97 a9 ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105cc9:	e8 42 ca ff ff       	call   80102710 <lapiceoi>
    break;
80105cce:	83 c4 10             	add    $0x10,%esp
80105cd1:	e9 0a ff ff ff       	jmp    80105be0 <trap+0xa0>
...
80105cd9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105ce0:	e8 6b c3 ff ff       	call   80102050 <ideintr>
80105ce5:	eb 96                	jmp    80105c7d <trap+0x13d>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105cf0:	e8 ab da ff ff       	call   801037a0 <myproc>
80105cf5:	8b 58 24             	mov    0x24(%eax),%ebx
80105cf8:	85 db                	test   %ebx,%ebx
80105cfa:	75 34                	jne    80105d30 <trap+0x1f0>
      exit(0);
    myproc()->tf = tf;
80105cfc:	e8 9f da ff ff       	call   801037a0 <myproc>
80105d01:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105d04:	e8 97 ee ff ff       	call   80104ba0 <syscall>
    if(myproc()->killed)
80105d09:	e8 92 da ff ff       	call   801037a0 <myproc>
80105d0e:	8b 48 24             	mov    0x24(%eax),%ecx
80105d11:	85 c9                	test   %ecx,%ecx
80105d13:	0f 84 16 ff ff ff    	je     80105c2f <trap+0xef>
      exit(0);
80105d19:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
    yield();
...
80105d26:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit(0);
80105d27:	e9 94 df ff ff       	jmp    80103cc0 <exit>
...
80105d35:	e8 86 df ff ff       	call   80103cc0 <exit>
80105d3a:	83 c4 10             	add    $0x10,%esp
80105d3d:	eb bd                	jmp    80105cfc <trap+0x1bc>
80105d3f:	90                   	nop
  }
...
80105d43:	68 60 82 11 80       	push   $0x80118260
80105d48:	e8 e3 e8 ff ff       	call   80104630 <acquire>
      ticks++;
      wakeup(&ticks);
80105d4d:	c7 04 24 a0 8a 11 80 	movl   $0x80118aa0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105d54:	83 05 a0 8a 11 80 01 	addl   $0x1,0x80118aa0
      wakeup(&ticks);
80105d5b:	e8 10 e5 ff ff       	call   80104270 <wakeup>
      release(&tickslock);
80105d60:	c7 04 24 60 82 11 80 	movl   $0x80118260,(%esp)
80105d67:	e8 e4 e9 ff ff       	call   80104750 <release>
80105d6c:	83 c4 10             	add    $0x10,%esp
80105d6f:	e9 09 ff ff ff       	jmp    80105c7d <trap+0x13d>
...
80105df5:	e8 36 c9 ff ff       	call   80102730 <microdelay>
{
  int i;
...
80105e8f:	bb ec 7b 10 80       	mov    $0x80107bec,%ebx
80105e94:	6a 00                	push   $0x0
80105e96:	6a 04                	push   $0x4
80105e98:	e8 03 c4 ff ff       	call   801022a0 <ioapicenable>
...
80105f1b:	e8 d0 a8 ff ff       	call   801007f0 <consoleintr>
}
...
80105f27:	6a 00                	push   $0x0
  jmp alltraps
80105f29:	e9 13 fb ff ff       	jmp    80105a41 <alltraps>
...
80105f30:	6a 01                	push   $0x1
  jmp alltraps
80105f32:	e9 0a fb ff ff       	jmp    80105a41 <alltraps>
...
80105f39:	6a 02                	push   $0x2
  jmp alltraps
80105f3b:	e9 01 fb ff ff       	jmp    80105a41 <alltraps>
...
80105f42:	6a 03                	push   $0x3
  jmp alltraps
80105f44:	e9 f8 fa ff ff       	jmp    80105a41 <alltraps>
...
80105f4b:	6a 04                	push   $0x4
  jmp alltraps
80105f4d:	e9 ef fa ff ff       	jmp    80105a41 <alltraps>
...
80105f54:	6a 05                	push   $0x5
  jmp alltraps
80105f56:	e9 e6 fa ff ff       	jmp    80105a41 <alltraps>
...
80105f5d:	6a 06                	push   $0x6
  jmp alltraps
80105f5f:	e9 dd fa ff ff       	jmp    80105a41 <alltraps>
...
80105f66:	6a 07                	push   $0x7
  jmp alltraps
80105f68:	e9 d4 fa ff ff       	jmp    80105a41 <alltraps>
...
80105f6d:	6a 08                	push   $0x8
  jmp alltraps
80105f6f:	e9 cd fa ff ff       	jmp    80105a41 <alltraps>
...
80105f76:	6a 09                	push   $0x9
  jmp alltraps
80105f78:	e9 c4 fa ff ff       	jmp    80105a41 <alltraps>
...
80105f7d:	6a 0a                	push   $0xa
  jmp alltraps
80105f7f:	e9 bd fa ff ff       	jmp    80105a41 <alltraps>
...
80105f84:	6a 0b                	push   $0xb
  jmp alltraps
80105f86:	e9 b6 fa ff ff       	jmp    80105a41 <alltraps>
...
80105f8b:	6a 0c                	push   $0xc
  jmp alltraps
80105f8d:	e9 af fa ff ff       	jmp    80105a41 <alltraps>
...
80105f92:	6a 0d                	push   $0xd
  jmp alltraps
80105f94:	e9 a8 fa ff ff       	jmp    80105a41 <alltraps>
...
80105f99:	6a 0e                	push   $0xe
  jmp alltraps
80105f9b:	e9 a1 fa ff ff       	jmp    80105a41 <alltraps>
...
80105fa2:	6a 0f                	push   $0xf
  jmp alltraps
80105fa4:	e9 98 fa ff ff       	jmp    80105a41 <alltraps>
...
80105fab:	6a 10                	push   $0x10
  jmp alltraps
80105fad:	e9 8f fa ff ff       	jmp    80105a41 <alltraps>
...
80105fb2:	6a 11                	push   $0x11
  jmp alltraps
80105fb4:	e9 88 fa ff ff       	jmp    80105a41 <alltraps>
...
80105fbb:	6a 12                	push   $0x12
  jmp alltraps
80105fbd:	e9 7f fa ff ff       	jmp    80105a41 <alltraps>
...
80105fc4:	6a 13                	push   $0x13
  jmp alltraps
80105fc6:	e9 76 fa ff ff       	jmp    80105a41 <alltraps>
...
80105fcd:	6a 14                	push   $0x14
  jmp alltraps
80105fcf:	e9 6d fa ff ff       	jmp    80105a41 <alltraps>
...
80105fd6:	6a 15                	push   $0x15
  jmp alltraps
80105fd8:	e9 64 fa ff ff       	jmp    80105a41 <alltraps>
...
80105fdf:	6a 16                	push   $0x16
  jmp alltraps
80105fe1:	e9 5b fa ff ff       	jmp    80105a41 <alltraps>
...
80105fe8:	6a 17                	push   $0x17
  jmp alltraps
80105fea:	e9 52 fa ff ff       	jmp    80105a41 <alltraps>
...
80105ff1:	6a 18                	push   $0x18
  jmp alltraps
80105ff3:	e9 49 fa ff ff       	jmp    80105a41 <alltraps>
...
80105ffa:	6a 19                	push   $0x19
  jmp alltraps
80105ffc:	e9 40 fa ff ff       	jmp    80105a41 <alltraps>
...
80106003:	6a 1a                	push   $0x1a
  jmp alltraps
80106005:	e9 37 fa ff ff       	jmp    80105a41 <alltraps>
...
8010600c:	6a 1b                	push   $0x1b
  jmp alltraps
8010600e:	e9 2e fa ff ff       	jmp    80105a41 <alltraps>
...
80106015:	6a 1c                	push   $0x1c
  jmp alltraps
80106017:	e9 25 fa ff ff       	jmp    80105a41 <alltraps>
...
8010601e:	6a 1d                	push   $0x1d
  jmp alltraps
80106020:	e9 1c fa ff ff       	jmp    80105a41 <alltraps>
...
80106027:	6a 1e                	push   $0x1e
  jmp alltraps
80106029:	e9 13 fa ff ff       	jmp    80105a41 <alltraps>
...
80106030:	6a 1f                	push   $0x1f
  jmp alltraps
80106032:	e9 0a fa ff ff       	jmp    80105a41 <alltraps>
...
80106039:	6a 20                	push   $0x20
  jmp alltraps
8010603b:	e9 01 fa ff ff       	jmp    80105a41 <alltraps>
...
80106042:	6a 21                	push   $0x21
  jmp alltraps
80106044:	e9 f8 f9 ff ff       	jmp    80105a41 <alltraps>
...
8010604b:	6a 22                	push   $0x22
  jmp alltraps
8010604d:	e9 ef f9 ff ff       	jmp    80105a41 <alltraps>
...
80106054:	6a 23                	push   $0x23
  jmp alltraps
80106056:	e9 e6 f9 ff ff       	jmp    80105a41 <alltraps>
...
8010605d:	6a 24                	push   $0x24
  jmp alltraps
8010605f:	e9 dd f9 ff ff       	jmp    80105a41 <alltraps>
...
80106066:	6a 25                	push   $0x25
  jmp alltraps
80106068:	e9 d4 f9 ff ff       	jmp    80105a41 <alltraps>
...
8010606f:	6a 26                	push   $0x26
  jmp alltraps
80106071:	e9 cb f9 ff ff       	jmp    80105a41 <alltraps>
...
80106078:	6a 27                	push   $0x27
  jmp alltraps
8010607a:	e9 c2 f9 ff ff       	jmp    80105a41 <alltraps>
...
80106081:	6a 28                	push   $0x28
  jmp alltraps
80106083:	e9 b9 f9 ff ff       	jmp    80105a41 <alltraps>
...
8010608a:	6a 29                	push   $0x29
  jmp alltraps
8010608c:	e9 b0 f9 ff ff       	jmp    80105a41 <alltraps>
...
80106093:	6a 2a                	push   $0x2a
  jmp alltraps
80106095:	e9 a7 f9 ff ff       	jmp    80105a41 <alltraps>
...
8010609c:	6a 2b                	push   $0x2b
  jmp alltraps
8010609e:	e9 9e f9 ff ff       	jmp    80105a41 <alltraps>
...
801060a5:	6a 2c                	push   $0x2c
  jmp alltraps
801060a7:	e9 95 f9 ff ff       	jmp    80105a41 <alltraps>
...
801060ae:	6a 2d                	push   $0x2d
  jmp alltraps
801060b0:	e9 8c f9 ff ff       	jmp    80105a41 <alltraps>
...
801060b7:	6a 2e                	push   $0x2e
  jmp alltraps
801060b9:	e9 83 f9 ff ff       	jmp    80105a41 <alltraps>
...
801060c0:	6a 2f                	push   $0x2f
  jmp alltraps
801060c2:	e9 7a f9 ff ff       	jmp    80105a41 <alltraps>
...
801060c9:	6a 30                	push   $0x30
  jmp alltraps
801060cb:	e9 71 f9 ff ff       	jmp    80105a41 <alltraps>
...
801060d2:	6a 31                	push   $0x31
  jmp alltraps
801060d4:	e9 68 f9 ff ff       	jmp    80105a41 <alltraps>
...
801060db:	6a 32                	push   $0x32
  jmp alltraps
801060dd:	e9 5f f9 ff ff       	jmp    80105a41 <alltraps>
...
801060e4:	6a 33                	push   $0x33
  jmp alltraps
801060e6:	e9 56 f9 ff ff       	jmp    80105a41 <alltraps>
...
801060ed:	6a 34                	push   $0x34
  jmp alltraps
801060ef:	e9 4d f9 ff ff       	jmp    80105a41 <alltraps>
...
801060f6:	6a 35                	push   $0x35
  jmp alltraps
801060f8:	e9 44 f9 ff ff       	jmp    80105a41 <alltraps>
...
801060ff:	6a 36                	push   $0x36
  jmp alltraps
80106101:	e9 3b f9 ff ff       	jmp    80105a41 <alltraps>
...
80106108:	6a 37                	push   $0x37
  jmp alltraps
8010610a:	e9 32 f9 ff ff       	jmp    80105a41 <alltraps>
...
80106111:	6a 38                	push   $0x38
  jmp alltraps
80106113:	e9 29 f9 ff ff       	jmp    80105a41 <alltraps>
...
8010611a:	6a 39                	push   $0x39
  jmp alltraps
8010611c:	e9 20 f9 ff ff       	jmp    80105a41 <alltraps>
...
80106123:	6a 3a                	push   $0x3a
  jmp alltraps
80106125:	e9 17 f9 ff ff       	jmp    80105a41 <alltraps>
...
8010612c:	6a 3b                	push   $0x3b
  jmp alltraps
8010612e:	e9 0e f9 ff ff       	jmp    80105a41 <alltraps>
...
80106135:	6a 3c                	push   $0x3c
  jmp alltraps
80106137:	e9 05 f9 ff ff       	jmp    80105a41 <alltraps>
...
8010613e:	6a 3d                	push   $0x3d
  jmp alltraps
80106140:	e9 fc f8 ff ff       	jmp    80105a41 <alltraps>
...
80106147:	6a 3e                	push   $0x3e
  jmp alltraps
80106149:	e9 f3 f8 ff ff       	jmp    80105a41 <alltraps>
...
80106150:	6a 3f                	push   $0x3f
  jmp alltraps
80106152:	e9 ea f8 ff ff       	jmp    80105a41 <alltraps>
...
80106159:	6a 40                	push   $0x40
  jmp alltraps
8010615b:	e9 e1 f8 ff ff       	jmp    80105a41 <alltraps>
...
80106162:	6a 41                	push   $0x41
  jmp alltraps
80106164:	e9 d8 f8 ff ff       	jmp    80105a41 <alltraps>
...
8010616b:	6a 42                	push   $0x42
  jmp alltraps
8010616d:	e9 cf f8 ff ff       	jmp    80105a41 <alltraps>
...
80106174:	6a 43                	push   $0x43
  jmp alltraps
80106176:	e9 c6 f8 ff ff       	jmp    80105a41 <alltraps>
...
8010617d:	6a 44                	push   $0x44
  jmp alltraps
8010617f:	e9 bd f8 ff ff       	jmp    80105a41 <alltraps>
...
80106186:	6a 45                	push   $0x45
  jmp alltraps
80106188:	e9 b4 f8 ff ff       	jmp    80105a41 <alltraps>
...
8010618f:	6a 46                	push   $0x46
  jmp alltraps
80106191:	e9 ab f8 ff ff       	jmp    80105a41 <alltraps>
...
80106198:	6a 47                	push   $0x47
  jmp alltraps
8010619a:	e9 a2 f8 ff ff       	jmp    80105a41 <alltraps>
...
801061a1:	6a 48                	push   $0x48
  jmp alltraps
801061a3:	e9 99 f8 ff ff       	jmp    80105a41 <alltraps>
...
801061aa:	6a 49                	push   $0x49
  jmp alltraps
801061ac:	e9 90 f8 ff ff       	jmp    80105a41 <alltraps>
...
801061b3:	6a 4a                	push   $0x4a
  jmp alltraps
801061b5:	e9 87 f8 ff ff       	jmp    80105a41 <alltraps>
...
801061bc:	6a 4b                	push   $0x4b
  jmp alltraps
801061be:	e9 7e f8 ff ff       	jmp    80105a41 <alltraps>
...
801061c5:	6a 4c                	push   $0x4c
  jmp alltraps
801061c7:	e9 75 f8 ff ff       	jmp    80105a41 <alltraps>
...
801061ce:	6a 4d                	push   $0x4d
  jmp alltraps
801061d0:	e9 6c f8 ff ff       	jmp    80105a41 <alltraps>
...
801061d7:	6a 4e                	push   $0x4e
  jmp alltraps
801061d9:	e9 63 f8 ff ff       	jmp    80105a41 <alltraps>
...
801061e0:	6a 4f                	push   $0x4f
  jmp alltraps
801061e2:	e9 5a f8 ff ff       	jmp    80105a41 <alltraps>
...
801061e9:	6a 50                	push   $0x50
  jmp alltraps
801061eb:	e9 51 f8 ff ff       	jmp    80105a41 <alltraps>
...
801061f2:	6a 51                	push   $0x51
  jmp alltraps
801061f4:	e9 48 f8 ff ff       	jmp    80105a41 <alltraps>
...
801061fb:	6a 52                	push   $0x52
  jmp alltraps
801061fd:	e9 3f f8 ff ff       	jmp    80105a41 <alltraps>
...
80106204:	6a 53                	push   $0x53
  jmp alltraps
80106206:	e9 36 f8 ff ff       	jmp    80105a41 <alltraps>
...
8010620d:	6a 54                	push   $0x54
  jmp alltraps
8010620f:	e9 2d f8 ff ff       	jmp    80105a41 <alltraps>
...
80106216:	6a 55                	push   $0x55
  jmp alltraps
80106218:	e9 24 f8 ff ff       	jmp    80105a41 <alltraps>
...
8010621f:	6a 56                	push   $0x56
  jmp alltraps
80106221:	e9 1b f8 ff ff       	jmp    80105a41 <alltraps>
...
80106228:	6a 57                	push   $0x57
  jmp alltraps
8010622a:	e9 12 f8 ff ff       	jmp    80105a41 <alltraps>
...
80106231:	6a 58                	push   $0x58
  jmp alltraps
80106233:	e9 09 f8 ff ff       	jmp    80105a41 <alltraps>
...
8010623a:	6a 59                	push   $0x59
  jmp alltraps
8010623c:	e9 00 f8 ff ff       	jmp    80105a41 <alltraps>
...
80106243:	6a 5a                	push   $0x5a
  jmp alltraps
80106245:	e9 f7 f7 ff ff       	jmp    80105a41 <alltraps>
...
8010624c:	6a 5b                	push   $0x5b
  jmp alltraps
8010624e:	e9 ee f7 ff ff       	jmp    80105a41 <alltraps>
...
80106255:	6a 5c                	push   $0x5c
  jmp alltraps
80106257:	e9 e5 f7 ff ff       	jmp    80105a41 <alltraps>
...
8010625e:	6a 5d                	push   $0x5d
  jmp alltraps
80106260:	e9 dc f7 ff ff       	jmp    80105a41 <alltraps>
...
80106267:	6a 5e                	push   $0x5e
  jmp alltraps
80106269:	e9 d3 f7 ff ff       	jmp    80105a41 <alltraps>
...
80106270:	6a 5f                	push   $0x5f
  jmp alltraps
80106272:	e9 ca f7 ff ff       	jmp    80105a41 <alltraps>
...
80106279:	6a 60                	push   $0x60
  jmp alltraps
8010627b:	e9 c1 f7 ff ff       	jmp    80105a41 <alltraps>
...
80106282:	6a 61                	push   $0x61
  jmp alltraps
80106284:	e9 b8 f7 ff ff       	jmp    80105a41 <alltraps>
...
8010628b:	6a 62                	push   $0x62
  jmp alltraps
8010628d:	e9 af f7 ff ff       	jmp    80105a41 <alltraps>
...
80106294:	6a 63                	push   $0x63
  jmp alltraps
80106296:	e9 a6 f7 ff ff       	jmp    80105a41 <alltraps>
...
8010629d:	6a 64                	push   $0x64
  jmp alltraps
8010629f:	e9 9d f7 ff ff       	jmp    80105a41 <alltraps>
...
801062a6:	6a 65                	push   $0x65
  jmp alltraps
801062a8:	e9 94 f7 ff ff       	jmp    80105a41 <alltraps>
...
801062af:	6a 66                	push   $0x66
  jmp alltraps
801062b1:	e9 8b f7 ff ff       	jmp    80105a41 <alltraps>
...
801062b8:	6a 67                	push   $0x67
  jmp alltraps
801062ba:	e9 82 f7 ff ff       	jmp    80105a41 <alltraps>
...
801062c1:	6a 68                	push   $0x68
  jmp alltraps
801062c3:	e9 79 f7 ff ff       	jmp    80105a41 <alltraps>
...
801062ca:	6a 69                	push   $0x69
  jmp alltraps
801062cc:	e9 70 f7 ff ff       	jmp    80105a41 <alltraps>
...
801062d3:	6a 6a                	push   $0x6a
  jmp alltraps
801062d5:	e9 67 f7 ff ff       	jmp    80105a41 <alltraps>
...
801062dc:	6a 6b                	push   $0x6b
  jmp alltraps
801062de:	e9 5e f7 ff ff       	jmp    80105a41 <alltraps>
...
801062e5:	6a 6c                	push   $0x6c
  jmp alltraps
801062e7:	e9 55 f7 ff ff       	jmp    80105a41 <alltraps>
...
801062ee:	6a 6d                	push   $0x6d
  jmp alltraps
801062f0:	e9 4c f7 ff ff       	jmp    80105a41 <alltraps>
...
801062f7:	6a 6e                	push   $0x6e
  jmp alltraps
801062f9:	e9 43 f7 ff ff       	jmp    80105a41 <alltraps>
...
80106300:	6a 6f                	push   $0x6f
  jmp alltraps
80106302:	e9 3a f7 ff ff       	jmp    80105a41 <alltraps>
...
80106309:	6a 70                	push   $0x70
  jmp alltraps
8010630b:	e9 31 f7 ff ff       	jmp    80105a41 <alltraps>
...
80106312:	6a 71                	push   $0x71
  jmp alltraps
80106314:	e9 28 f7 ff ff       	jmp    80105a41 <alltraps>
...
8010631b:	6a 72                	push   $0x72
  jmp alltraps
8010631d:	e9 1f f7 ff ff       	jmp    80105a41 <alltraps>
...
80106324:	6a 73                	push   $0x73
  jmp alltraps
80106326:	e9 16 f7 ff ff       	jmp    80105a41 <alltraps>
...
8010632d:	6a 74                	push   $0x74
  jmp alltraps
8010632f:	e9 0d f7 ff ff       	jmp    80105a41 <alltraps>
...
80106336:	6a 75                	push   $0x75
  jmp alltraps
80106338:	e9 04 f7 ff ff       	jmp    80105a41 <alltraps>
...
8010633f:	6a 76                	push   $0x76
  jmp alltraps
80106341:	e9 fb f6 ff ff       	jmp    80105a41 <alltraps>
...
80106348:	6a 77                	push   $0x77
  jmp alltraps
8010634a:	e9 f2 f6 ff ff       	jmp    80105a41 <alltraps>
...
80106351:	6a 78                	push   $0x78
  jmp alltraps
80106353:	e9 e9 f6 ff ff       	jmp    80105a41 <alltraps>
...
8010635a:	6a 79                	push   $0x79
  jmp alltraps
8010635c:	e9 e0 f6 ff ff       	jmp    80105a41 <alltraps>
...
80106363:	6a 7a                	push   $0x7a
  jmp alltraps
80106365:	e9 d7 f6 ff ff       	jmp    80105a41 <alltraps>
...
8010636c:	6a 7b                	push   $0x7b
  jmp alltraps
8010636e:	e9 ce f6 ff ff       	jmp    80105a41 <alltraps>
...
80106375:	6a 7c                	push   $0x7c
  jmp alltraps
80106377:	e9 c5 f6 ff ff       	jmp    80105a41 <alltraps>
...
8010637e:	6a 7d                	push   $0x7d
  jmp alltraps
80106380:	e9 bc f6 ff ff       	jmp    80105a41 <alltraps>
...
80106387:	6a 7e                	push   $0x7e
  jmp alltraps
80106389:	e9 b3 f6 ff ff       	jmp    80105a41 <alltraps>
...
80106390:	6a 7f                	push   $0x7f
  jmp alltraps
80106392:	e9 aa f6 ff ff       	jmp    80105a41 <alltraps>
...
80106399:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010639e:	e9 9e f6 ff ff       	jmp    80105a41 <alltraps>
...
801063a5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063aa:	e9 92 f6 ff ff       	jmp    80105a41 <alltraps>
...
801063b1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063b6:	e9 86 f6 ff ff       	jmp    80105a41 <alltraps>
...
801063bd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063c2:	e9 7a f6 ff ff       	jmp    80105a41 <alltraps>
...
801063c9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063ce:	e9 6e f6 ff ff       	jmp    80105a41 <alltraps>
...
801063d5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063da:	e9 62 f6 ff ff       	jmp    80105a41 <alltraps>
...
801063e1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063e6:	e9 56 f6 ff ff       	jmp    80105a41 <alltraps>
...
801063ed:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063f2:	e9 4a f6 ff ff       	jmp    80105a41 <alltraps>
...
801063f9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063fe:	e9 3e f6 ff ff       	jmp    80105a41 <alltraps>
...
80106405:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010640a:	e9 32 f6 ff ff       	jmp    80105a41 <alltraps>
...
80106411:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106416:	e9 26 f6 ff ff       	jmp    80105a41 <alltraps>
...
8010641d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106422:	e9 1a f6 ff ff       	jmp    80105a41 <alltraps>
...
80106429:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010642e:	e9 0e f6 ff ff       	jmp    80105a41 <alltraps>
...
80106435:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010643a:	e9 02 f6 ff ff       	jmp    80105a41 <alltraps>
...
80106441:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106446:	e9 f6 f5 ff ff       	jmp    80105a41 <alltraps>
...
8010644d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106452:	e9 ea f5 ff ff       	jmp    80105a41 <alltraps>
...
80106459:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010645e:	e9 de f5 ff ff       	jmp    80105a41 <alltraps>
...
80106465:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010646a:	e9 d2 f5 ff ff       	jmp    80105a41 <alltraps>
...
80106471:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106476:	e9 c6 f5 ff ff       	jmp    80105a41 <alltraps>
...
8010647d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106482:	e9 ba f5 ff ff       	jmp    80105a41 <alltraps>
...
80106489:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010648e:	e9 ae f5 ff ff       	jmp    80105a41 <alltraps>
...
80106495:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010649a:	e9 a2 f5 ff ff       	jmp    80105a41 <alltraps>
...
801064a1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064a6:	e9 96 f5 ff ff       	jmp    80105a41 <alltraps>
...
801064ad:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064b2:	e9 8a f5 ff ff       	jmp    80105a41 <alltraps>
...
801064b9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064be:	e9 7e f5 ff ff       	jmp    80105a41 <alltraps>
...
801064c5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064ca:	e9 72 f5 ff ff       	jmp    80105a41 <alltraps>
...
801064d1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064d6:	e9 66 f5 ff ff       	jmp    80105a41 <alltraps>
...
801064dd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064e2:	e9 5a f5 ff ff       	jmp    80105a41 <alltraps>
...
801064e9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064ee:	e9 4e f5 ff ff       	jmp    80105a41 <alltraps>
...
801064f5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064fa:	e9 42 f5 ff ff       	jmp    80105a41 <alltraps>
...
80106501:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106506:	e9 36 f5 ff ff       	jmp    80105a41 <alltraps>
...
8010650d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106512:	e9 2a f5 ff ff       	jmp    80105a41 <alltraps>
...
80106519:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010651e:	e9 1e f5 ff ff       	jmp    80105a41 <alltraps>
...
80106525:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010652a:	e9 12 f5 ff ff       	jmp    80105a41 <alltraps>
...
80106531:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106536:	e9 06 f5 ff ff       	jmp    80105a41 <alltraps>
...
8010653d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106542:	e9 fa f4 ff ff       	jmp    80105a41 <alltraps>
...
80106549:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010654e:	e9 ee f4 ff ff       	jmp    80105a41 <alltraps>
...
80106555:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010655a:	e9 e2 f4 ff ff       	jmp    80105a41 <alltraps>
...
80106561:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106566:	e9 d6 f4 ff ff       	jmp    80105a41 <alltraps>
...
8010656d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106572:	e9 ca f4 ff ff       	jmp    80105a41 <alltraps>
...
80106579:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010657e:	e9 be f4 ff ff       	jmp    80105a41 <alltraps>
...
80106585:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010658a:	e9 b2 f4 ff ff       	jmp    80105a41 <alltraps>
...
80106591:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106596:	e9 a6 f4 ff ff       	jmp    80105a41 <alltraps>
...
8010659d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065a2:	e9 9a f4 ff ff       	jmp    80105a41 <alltraps>
...
801065a9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065ae:	e9 8e f4 ff ff       	jmp    80105a41 <alltraps>
...
801065b5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065ba:	e9 82 f4 ff ff       	jmp    80105a41 <alltraps>
...
801065c1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065c6:	e9 76 f4 ff ff       	jmp    80105a41 <alltraps>
...
801065cd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065d2:	e9 6a f4 ff ff       	jmp    80105a41 <alltraps>
...
801065d9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065de:	e9 5e f4 ff ff       	jmp    80105a41 <alltraps>
...
801065e5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065ea:	e9 52 f4 ff ff       	jmp    80105a41 <alltraps>
...
801065f1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065f6:	e9 46 f4 ff ff       	jmp    80105a41 <alltraps>
...
801065fd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106602:	e9 3a f4 ff ff       	jmp    80105a41 <alltraps>
...
80106609:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010660e:	e9 2e f4 ff ff       	jmp    80105a41 <alltraps>
...
80106615:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010661a:	e9 22 f4 ff ff       	jmp    80105a41 <alltraps>
...
80106621:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106626:	e9 16 f4 ff ff       	jmp    80105a41 <alltraps>
...
8010662d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106632:	e9 0a f4 ff ff       	jmp    80105a41 <alltraps>
...
80106639:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010663e:	e9 fe f3 ff ff       	jmp    80105a41 <alltraps>
...
80106645:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010664a:	e9 f2 f3 ff ff       	jmp    80105a41 <alltraps>
...
80106651:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106656:	e9 e6 f3 ff ff       	jmp    80105a41 <alltraps>
...
8010665d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106662:	e9 da f3 ff ff       	jmp    80105a41 <alltraps>
...
80106669:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010666e:	e9 ce f3 ff ff       	jmp    80105a41 <alltraps>
...
80106675:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010667a:	e9 c2 f3 ff ff       	jmp    80105a41 <alltraps>
...
80106681:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106686:	e9 b6 f3 ff ff       	jmp    80105a41 <alltraps>
...
8010668d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106692:	e9 aa f3 ff ff       	jmp    80105a41 <alltraps>
...
80106699:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010669e:	e9 9e f3 ff ff       	jmp    80105a41 <alltraps>
...
801066a5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066aa:	e9 92 f3 ff ff       	jmp    80105a41 <alltraps>
...
801066b1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066b6:	e9 86 f3 ff ff       	jmp    80105a41 <alltraps>
...
801066bd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066c2:	e9 7a f3 ff ff       	jmp    80105a41 <alltraps>
...
801066c9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066ce:	e9 6e f3 ff ff       	jmp    80105a41 <alltraps>
...
801066d5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066da:	e9 62 f3 ff ff       	jmp    80105a41 <alltraps>
...
801066e1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066e6:	e9 56 f3 ff ff       	jmp    80105a41 <alltraps>
...
801066ed:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066f2:	e9 4a f3 ff ff       	jmp    80105a41 <alltraps>
...
801066f9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066fe:	e9 3e f3 ff ff       	jmp    80105a41 <alltraps>
...
80106705:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010670a:	e9 32 f3 ff ff       	jmp    80105a41 <alltraps>
...
80106711:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106716:	e9 26 f3 ff ff       	jmp    80105a41 <alltraps>
...
8010671d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106722:	e9 1a f3 ff ff       	jmp    80105a41 <alltraps>
...
80106729:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010672e:	e9 0e f3 ff ff       	jmp    80105a41 <alltraps>
...
80106735:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010673a:	e9 02 f3 ff ff       	jmp    80105a41 <alltraps>
...
80106741:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106746:	e9 f6 f2 ff ff       	jmp    80105a41 <alltraps>
...
8010674d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106752:	e9 ea f2 ff ff       	jmp    80105a41 <alltraps>
...
80106759:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010675e:	e9 de f2 ff ff       	jmp    80105a41 <alltraps>
...
80106765:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010676a:	e9 d2 f2 ff ff       	jmp    80105a41 <alltraps>
...
80106771:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106776:	e9 c6 f2 ff ff       	jmp    80105a41 <alltraps>
...
8010677d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106782:	e9 ba f2 ff ff       	jmp    80105a41 <alltraps>
...
80106789:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010678e:	e9 ae f2 ff ff       	jmp    80105a41 <alltraps>
...
80106795:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010679a:	e9 a2 f2 ff ff       	jmp    80105a41 <alltraps>
...
801067a1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067a6:	e9 96 f2 ff ff       	jmp    80105a41 <alltraps>
...
801067ad:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067b2:	e9 8a f2 ff ff       	jmp    80105a41 <alltraps>
...
801067b9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067be:	e9 7e f2 ff ff       	jmp    80105a41 <alltraps>
...
801067c5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067ca:	e9 72 f2 ff ff       	jmp    80105a41 <alltraps>
...
801067d1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067d6:	e9 66 f2 ff ff       	jmp    80105a41 <alltraps>
...
801067dd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067e2:	e9 5a f2 ff ff       	jmp    80105a41 <alltraps>
...
801067e9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067ee:	e9 4e f2 ff ff       	jmp    80105a41 <alltraps>
...
801067f5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067fa:	e9 42 f2 ff ff       	jmp    80105a41 <alltraps>
...
80106801:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106806:	e9 36 f2 ff ff       	jmp    80105a41 <alltraps>
...
8010680d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106812:	e9 2a f2 ff ff       	jmp    80105a41 <alltraps>
...
80106819:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010681e:	e9 1e f2 ff ff       	jmp    80105a41 <alltraps>
...
80106825:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010682a:	e9 12 f2 ff ff       	jmp    80105a41 <alltraps>
...
80106831:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106836:	e9 06 f2 ff ff       	jmp    80105a41 <alltraps>
...
8010683d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106842:	e9 fa f1 ff ff       	jmp    80105a41 <alltraps>
...
80106849:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010684e:	e9 ee f1 ff ff       	jmp    80105a41 <alltraps>
...
80106855:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010685a:	e9 e2 f1 ff ff       	jmp    80105a41 <alltraps>
...
80106861:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106866:	e9 d6 f1 ff ff       	jmp    80105a41 <alltraps>
...
8010686d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106872:	e9 ca f1 ff ff       	jmp    80105a41 <alltraps>
...
80106879:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010687e:	e9 be f1 ff ff       	jmp    80105a41 <alltraps>
...
80106885:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010688a:	e9 b2 f1 ff ff       	jmp    80105a41 <alltraps>
...
80106891:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106896:	e9 a6 f1 ff ff       	jmp    80105a41 <alltraps>
...
8010689d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068a2:	e9 9a f1 ff ff       	jmp    80105a41 <alltraps>
...
801068a9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068ae:	e9 8e f1 ff ff       	jmp    80105a41 <alltraps>
...
801068b5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068ba:	e9 82 f1 ff ff       	jmp    80105a41 <alltraps>
...
801068c1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068c6:	e9 76 f1 ff ff       	jmp    80105a41 <alltraps>
...
801068cd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068d2:	e9 6a f1 ff ff       	jmp    80105a41 <alltraps>
...
801068d9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068de:	e9 5e f1 ff ff       	jmp    80105a41 <alltraps>
...
801068e5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068ea:	e9 52 f1 ff ff       	jmp    80105a41 <alltraps>
...
801068f1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068f6:	e9 46 f1 ff ff       	jmp    80105a41 <alltraps>
...
801068fd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106902:	e9 3a f1 ff ff       	jmp    80105a41 <alltraps>
...
80106909:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010690e:	e9 2e f1 ff ff       	jmp    80105a41 <alltraps>
...
80106915:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010691a:	e9 22 f1 ff ff       	jmp    80105a41 <alltraps>
...
80106921:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106926:	e9 16 f1 ff ff       	jmp    80105a41 <alltraps>
...
8010692d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106932:	e9 0a f1 ff ff       	jmp    80105a41 <alltraps>
...
80106939:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010693e:	e9 fe f0 ff ff       	jmp    80105a41 <alltraps>
...
80106945:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010694a:	e9 f2 f0 ff ff       	jmp    80105a41 <alltraps>
...
80106951:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106956:	e9 e6 f0 ff ff       	jmp    80105a41 <alltraps>
...
8010695d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106962:	e9 da f0 ff ff       	jmp    80105a41 <alltraps>
...
80106969:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010696e:	e9 ce f0 ff ff       	jmp    80105a41 <alltraps>
...
80106975:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010697a:	e9 c2 f0 ff ff       	jmp    80105a41 <alltraps>
...
80106981:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106986:	e9 b6 f0 ff ff       	jmp    80105a41 <alltraps>
...
8010698d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106992:	e9 aa f0 ff ff       	jmp    80105a41 <alltraps>
...
801069a6:	89 d3                	mov    %edx,%ebx
  ...
  pde = &pgdir[PDX(va)];
801069a8:	c1 ea 16             	shr    $0x16,%edx
...
801069ae:	83 ec 0c             	sub    $0xc,%esp
  ...
  pde = &pgdir[PDX(va)];
  if(*pde & PTE_P){
801069b1:	8b 07                	mov    (%edi),%eax
801069b3:	a8 01                	test   $0x1,%al
801069b5:	74 29                	je     801069e0 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801069b7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801069bc:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
...
801069c2:	8d 65 f4             	lea    -0xc(%ebp),%esp
  ...
  return &pgtab[PTX(va)];
801069c5:	c1 eb 0a             	shr    $0xa,%ebx
801069c8:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
801069ce:	8d 04 1e             	lea    (%esi,%ebx,1),%eax
}
801069d1:	5b                   	pop    %ebx
801069d2:	5e                   	pop    %esi
801069d3:	5f                   	pop    %edi
...
801069e4:	e8 a7 ba ff ff       	call   80102490 <kalloc>
801069e9:	85 c0                	test   %eax,%eax
801069eb:	89 c6                	mov    %eax,%esi
...
801069fa:	e8 a1 dd ff ff       	call   801047a0 <memset>
    ...
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801069ff:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106a05:	83 c4 10             	add    $0x10,%esp
80106a08:	83 c8 07             	or     $0x7,%eax
80106a0b:	89 07                	mov    %eax,(%edi)
80106a0d:	eb b3                	jmp    801069c2 <walkpgdir+0x22>
80106a0f:	90                   	nop
  }
  return &pgtab[PTX(va)];
}
...
80106a9d:	68 f4 7b 10 80       	push   $0x80107bf4
...
80106af4:	e8 e7 b7 ff ff       	call   801022e0 <kfree>
      *pte = 0;
...
80106b42:	68 86 75 10 80       	push   $0x80107586
80106b47:	e8 24 98 ff ff       	call   80100370 <panic>
...
80106b53:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106b56:	e8 25 cc ff ff       	call   80103780 <cpuid>
...
80106b68:	66 89 90 f8 27 11 80 	mov    %dx,-0x7feed808(%eax)
80106b6f:	66 89 88 fa 27 11 80 	mov    %cx,-0x7feed806(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b76:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106b7b:	31 c9                	xor    %ecx,%ecx
80106b7d:	66 89 90 00 28 11 80 	mov    %dx,-0x7feed800(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b84:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b89:	66 89 88 02 28 11 80 	mov    %cx,-0x7feed7fe(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b90:	31 c9                	xor    %ecx,%ecx
80106b92:	66 89 90 08 28 11 80 	mov    %dx,-0x7feed7f8(%eax)
80106b99:	66 89 88 0a 28 11 80 	mov    %cx,-0x7feed7f6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ba0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106ba5:	31 c9                	xor    %ecx,%ecx
80106ba7:	66 89 90 10 28 11 80 	mov    %dx,-0x7feed7f0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106bae:	c6 80 fc 27 11 80 00 	movb   $0x0,-0x7feed804(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80106bb5:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106bba:	c6 80 fd 27 11 80 9a 	movb   $0x9a,-0x7feed803(%eax)
80106bc1:	c6 80 fe 27 11 80 cf 	movb   $0xcf,-0x7feed802(%eax)
80106bc8:	c6 80 ff 27 11 80 00 	movb   $0x0,-0x7feed801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106bcf:	c6 80 04 28 11 80 00 	movb   $0x0,-0x7feed7fc(%eax)
80106bd6:	c6 80 05 28 11 80 92 	movb   $0x92,-0x7feed7fb(%eax)
80106bdd:	c6 80 06 28 11 80 cf 	movb   $0xcf,-0x7feed7fa(%eax)
80106be4:	c6 80 07 28 11 80 00 	movb   $0x0,-0x7feed7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106beb:	c6 80 0c 28 11 80 00 	movb   $0x0,-0x7feed7f4(%eax)
80106bf2:	c6 80 0d 28 11 80 fa 	movb   $0xfa,-0x7feed7f3(%eax)
80106bf9:	c6 80 0e 28 11 80 cf 	movb   $0xcf,-0x7feed7f2(%eax)
80106c00:	c6 80 0f 28 11 80 00 	movb   $0x0,-0x7feed7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106c07:	66 89 88 12 28 11 80 	mov    %cx,-0x7feed7ee(%eax)
80106c0e:	c6 80 14 28 11 80 00 	movb   $0x0,-0x7feed7ec(%eax)
80106c15:	c6 80 15 28 11 80 f2 	movb   $0xf2,-0x7feed7eb(%eax)
80106c1c:	c6 80 16 28 11 80 cf 	movb   $0xcf,-0x7feed7ea(%eax)
80106c23:	c6 80 17 28 11 80 00 	movb   $0x0,-0x7feed7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80106c2a:	05 f0 27 11 80       	add    $0x801127f0,%eax
80106c2f:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
80106c33:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106c37:	c1 e8 10             	shr    $0x10,%eax
80106c3a:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106c3e:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106c41:	0f 01 10             	lgdtl  (%eax)
}
80106c44:	c9                   	leave  
80106c45:	c3                   	ret    
...
80106c50:	a1 a4 8a 11 80       	mov    0x80118aa4,%eax
...
80106c7e:	0f 84 cd 00 00 00    	je     80106d51 <switchuvm+0xe1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106c84:	8b 46 08             	mov    0x8(%esi),%eax
80106c87:	85 c0                	test   %eax,%eax
80106c89:	0f 84 dc 00 00 00    	je     80106d6b <switchuvm+0xfb>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106c8f:	8b 7e 04             	mov    0x4(%esi),%edi
80106c92:	85 ff                	test   %edi,%edi
80106c94:	0f 84 c4 00 00 00    	je     80106d5e <switchuvm+0xee>
    panic("switchuvm: no pgdir");

  pushcli();
80106c9a:	e8 51 d9 ff ff       	call   801045f0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c9f:	e8 5c ca ff ff       	call   80103700 <mycpu>
80106ca4:	89 c3                	mov    %eax,%ebx
80106ca6:	e8 55 ca ff ff       	call   80103700 <mycpu>
80106cab:	89 c7                	mov    %eax,%edi
80106cad:	e8 4e ca ff ff       	call   80103700 <mycpu>
80106cb2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106cb5:	83 c7 08             	add    $0x8,%edi
80106cb8:	e8 43 ca ff ff       	call   80103700 <mycpu>
...
80106ccb:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
80106cd2:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106cd9:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
80106ce0:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106ce7:	83 c1 08             	add    $0x8,%ecx
80106cea:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106cf0:	c1 e9 10             	shr    $0x10,%ecx
80106cf3:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
...
80106cf9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    panic("switchuvm: no pgdir");
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106cfe:	e8 fd c9 ff ff       	call   80103700 <mycpu>
80106d03:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106d0a:	e8 f1 c9 ff ff       	call   80103700 <mycpu>
80106d0f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106d14:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106d18:	e8 e3 c9 ff ff       	call   80103700 <mycpu>
80106d1d:	8b 56 08             	mov    0x8(%esi),%edx
80106d20:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106d26:	89 48 0c             	mov    %ecx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d29:	e8 d2 c9 ff ff       	call   80103700 <mycpu>
80106d2e:	66 89 58 6e          	mov    %bx,0x6e(%eax)
}
...
80106d32:	b8 28 00 00 00       	mov    $0x28,%eax
80106d37:	0f 00 d8             	ltr    %ax
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106d3a:	8b 46 04             	mov    0x4(%esi),%eax
80106d3d:	05 00 00 00 80       	add    $0x80000000,%eax
80106d42:	0f 22 d8             	mov    %eax,%cr3
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
}
80106d45:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106d48:	5b                   	pop    %ebx
80106d49:	5e                   	pop    %esi
80106d4a:	5f                   	pop    %edi
80106d4b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106d4c:	e9 8f d9 ff ff       	jmp    801046e0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106d54:	68 fa 7b 10 80       	push   $0x80107bfa
80106d59:	e8 12 96 ff ff       	call   80100370 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
80106d5e:	83 ec 0c             	sub    $0xc,%esp
80106d61:	68 25 7c 10 80       	push   $0x80107c25
80106d66:	e8 05 96 ff ff       	call   80100370 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
...
80106d6e:	68 10 7c 10 80       	push   $0x80107c10
80106d73:	e8 f8 95 ff ff       	call   80100370 <panic>
80106d78:	90                   	nop
...
80106d9b:	77 49                	ja     80106de6 <inituvm+0x66>
  ...
  mem = kalloc();
80106d9d:	e8 ee b6 ff ff       	call   80102490 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106daf:	e8 ec d9 ff ff       	call   801047a0 <memset>
...
80106dc9:	e8 52 fc ff ff       	call   80106a20 <mappages>
  memmove(mem, init, sz);
...
80106de0:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106de1:	e9 6a da ff ff       	jmp    80104850 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106de9:	68 39 7c 10 80       	push   $0x80107c39
...
80106e43:	e8 58 fb ff ff       	call   801069a0 <walkpgdir>
...
80106e71:	e8 da aa ff ff       	call   80101950 <readi>
...
80106e9d:	68 53 7c 10 80       	push   $0x80107c53
...
80106eaa:	68 f4 7c 10 80       	push   $0x80107cf4
...
80106ece:	0f 88 ca 00 00 00    	js     80106f9e <allocuvm+0xde>
    return 0;
  if(newsz < oldsz)
80106ed4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106ed7:	8b 45 0c             	mov    0xc(%ebp),%eax
  char *mem;
  uint a;
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80106eda:	0f 82 82 00 00 00    	jb     80106f62 <allocuvm+0xa2>
    return oldsz;
...
80106eec:	39 df                	cmp    %ebx,%edi
80106eee:	77 43                	ja     80106f33 <allocuvm+0x73>
80106ef0:	e9 bb 00 00 00       	jmp    80106fb0 <allocuvm+0xf0>
80106ef5:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    memset(mem, 0, PGSIZE);
80106ef8:	83 ec 04             	sub    $0x4,%esp
80106efb:	68 00 10 00 00       	push   $0x1000
80106f00:	6a 00                	push   $0x0
80106f02:	50                   	push   %eax
80106f03:	e8 98 d8 ff ff       	call   801047a0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106f08:	58                   	pop    %eax
80106f09:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106f0f:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106f14:	5a                   	pop    %edx
80106f15:	6a 06                	push   $0x6
80106f17:	50                   	push   %eax
80106f18:	89 da                	mov    %ebx,%edx
80106f1a:	8b 45 08             	mov    0x8(%ebp),%eax
80106f1d:	e8 fe fa ff ff       	call   80106a20 <mappages>
80106f22:	83 c4 10             	add    $0x10,%esp
80106f25:	85 c0                	test   %eax,%eax
80106f27:	78 47                	js     80106f70 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80106f2f:	39 df                	cmp    %ebx,%edi
80106f31:	76 7d                	jbe    80106fb0 <allocuvm+0xf0>
    mem = kalloc();
80106f33:	e8 58 b5 ff ff       	call   80102490 <kalloc>
    if(mem == 0){
80106f38:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
80106f3a:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106f3c:	75 ba                	jne    80106ef8 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106f3e:	83 ec 0c             	sub    $0xc,%esp
80106f41:	68 71 7c 10 80       	push   $0x80107c71
80106f46:	e8 15 97 ff ff       	call   80100660 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80106f4e:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106f51:	76 4b                	jbe    80106f9e <allocuvm+0xde>
80106f53:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106f56:	8b 45 08             	mov    0x8(%ebp),%eax
80106f59:	89 fa                	mov    %edi,%edx
80106f5b:	e8 50 fb ff ff       	call   80106ab0 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106f73:	68 89 7c 10 80       	push   $0x80107c89
...
80106f80:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106f83:	76 0d                	jbe    80106f92 <allocuvm+0xd2>
80106f85:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106f88:	8b 45 08             	mov    0x8(%ebp),%eax
80106f8b:	89 fa                	mov    %edi,%edx
80106f8d:	e8 1e fb ff ff       	call   80106ab0 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106f96:	e8 45 b3 ff ff       	call   801022e0 <kfree>
      return 0;
...
80106fd0:	5d                   	pop    %ebp
80106fd1:	e9 da fa ff ff       	jmp    80106ab0 <deallocuvm.part.0>
...
80107009:	e8 a2 fa ff ff       	call   80106ab0 <deallocuvm.part.0>
...
8010703e:	e8 9d b2 ff ff       	call   801022e0 <kfree>
...
80107053:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80107054:	e9 87 b2 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
8010705c:	68 a5 7c 10 80       	push   $0x80107ca5
80107061:	e8 0a 93 ff ff       	call   80100370 <panic>
...
80107075:	e8 16 b4 ff ff       	call   80102490 <kalloc>
8010707a:	85 c0                	test   %eax,%eax
8010707c:	74 6a                	je     801070e8 <setupkvm+0x78>
    return 0;
  memset(pgdir, 0, PGSIZE);
8010707e:	83 ec 04             	sub    $0x4,%esp
80107081:	89 c6                	mov    %eax,%esi
...
80107090:	e8 0b d7 ff ff       	call   801047a0 <memset>
...
801070ab:	e8 70 f9 ff ff       	call   80106a20 <mappages>
...
801070c4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801070c7:	5b                   	pop    %ebx
801070c8:	5e                   	pop    %esi
801070c9:	5d                   	pop    %ebp
801070ca:	c3                   	ret    
...
801070d4:	e8 17 ff ff ff       	call   80106ff0 <freevm>
      return 0;
801070d9:	83 c4 10             	add    $0x10,%esp
    }
  return pgdir;
}
801070dc:	8d 65 f8             	lea    -0x8(%ebp),%esp
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
...
801070e5:	8d 76 00             	lea    0x0(%esi),%esi
{
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
801070e8:	31 c0                	xor    %eax,%eax
801070ea:	eb d8                	jmp    801070c4 <setupkvm+0x54>
...
801070fb:	a3 a4 8a 11 80       	mov    %eax,0x80118aa4
...
8010711e:	e8 7d f8 ff ff       	call   801069a0 <walkpgdir>
  if(pte == 0)
...
8010712f:	68 b6 7c 10 80       	push   $0x80107cb6
...
80107153:	0f 84 b2 00 00 00    	je     8010720b <copyuvm+0xcb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107159:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010715c:	85 c9                	test   %ecx,%ecx
8010715e:	0f 84 9c 00 00 00    	je     80107200 <copyuvm+0xc0>
...
80107185:	58                   	pop    %eax
80107186:	5a                   	pop    %edx
80107187:	8d 93 00 00 00 80    	lea    -0x80000000(%ebx),%edx
8010718d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107190:	ff 75 e4             	pushl  -0x1c(%ebp)
80107193:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107198:	52                   	push   %edx
80107199:	89 f2                	mov    %esi,%edx
8010719b:	e8 80 f8 ff ff       	call   80106a20 <mappages>
801071a0:	83 c4 10             	add    $0x10,%esp
801071a3:	85 c0                	test   %eax,%eax
801071a5:	78 3e                	js     801071e5 <copyuvm+0xa5>
  uint pa, i, flags;
  char *mem;
...
801071b0:	76 4e                	jbe    80107200 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801071b2:	8b 45 08             	mov    0x8(%ebp),%eax
801071b5:	31 c9                	xor    %ecx,%ecx
801071b7:	89 f2                	mov    %esi,%edx
801071b9:	e8 e2 f7 ff ff       	call   801069a0 <walkpgdir>
801071be:	85 c0                	test   %eax,%eax
801071c0:	74 5a                	je     8010721c <copyuvm+0xdc>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
801071c2:	8b 18                	mov    (%eax),%ebx
801071c4:	f6 c3 01             	test   $0x1,%bl
801071c7:	74 46                	je     8010720f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801071c9:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
801071cb:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
801071d1:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801071d4:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
801071da:	e8 b1 b2 ff ff       	call   80102490 <kalloc>
801071df:	85 c0                	test   %eax,%eax
801071e1:	89 c3                	mov    %eax,%ebx
801071e3:	75 8b                	jne    80107170 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
801071e8:	ff 75 e0             	pushl  -0x20(%ebp)
801071eb:	e8 00 fe ff ff       	call   80106ff0 <freevm>
  return 0;
801071f0:	83 c4 10             	add    $0x10,%esp
801071f3:	31 c0                	xor    %eax,%eax
}
801071f5:	8d 65 f4             	lea    -0xc(%ebp),%esp
801071f8:	5b                   	pop    %ebx
801071f9:	5e                   	pop    %esi
801071fa:	5f                   	pop    %edi
801071fb:	5d                   	pop    %ebp
...
801071fd:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107200:	8b 45 e0             	mov    -0x20(%ebp),%eax
  return d;
...
8010720d:	eb e6                	jmp    801071f5 <copyuvm+0xb5>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80107212:	68 da 7c 10 80       	push   $0x80107cda
...
8010721f:	68 c0 7c 10 80       	push   $0x80107cc0
80107224:	e8 47 91 ff ff       	call   80100370 <panic>
...
8010723e:	e8 5d f7 ff ff       	call   801069a0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
801072af:	e8 9c d5 ff ff       	call   80104850 <memmove>
    len -= n;
    buf += n;
