...
80103617:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
8010361d:	e8 7e 10 00 00       	call   801046a0 <release>
...
8010363f:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103642:	c7 40 14 a9 59 10 80 	movl   $0x801059a9,0x14(%eax)
...
8010364e:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103651:	e8 9a 10 00 00       	call   801046f0 <memset>
...
80103678:	e8 23 10 00 00       	call   801046a0 <release>
  return 0;
...
8010369b:	e8 00 10 00 00       	call   801046a0 <release>
...
801036e6:	68 b5 77 10 80       	push   $0x801077b5
801036eb:	68 20 2d 11 80       	push   $0x80112d20
801036f0:	e8 8b 0d 00 00       	call   80104480 <initlock>
}
...
8010375d:	68 bc 77 10 80       	push   $0x801077bc
...
8010376a:	68 98 78 10 80       	push   $0x80107898
...
801037a4:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
801037a7:	e8 94 0d 00 00       	call   80104540 <pushcli>
  c = mycpu();
801037ac:	e8 4f ff ff ff       	call   80103700 <mycpu>
  p = c->proc;
801037b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037b7:	e8 74 0e 00 00       	call   80104630 <popcli>
  return p;
}
...
801037e3:	e8 d8 37 00 00       	call   80106fc0 <setupkvm>
...
80103801:	e8 ca 34 00 00       	call   80106cd0 <inituvm>
  p->sz = PGSIZE;
...
8010386f:	68 e5 77 10 80       	push   $0x801077e5
80103874:	50                   	push   %eax
80103875:	e8 76 10 00 00       	call   801048f0 <safestrcpy>
  p->cwd = namei("/");
8010387a:	c7 04 24 ee 77 10 80 	movl   $0x801077ee,(%esp)
...
80103890:	e8 eb 0c 00 00       	call   80104580 <acquire>
...
801038a3:	e8 f8 0d 00 00       	call   801046a0 <release>
}
...
801038b3:	68 cc 77 10 80       	push   $0x801077cc
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
801038c8:	e8 73 0c 00 00       	call   80104540 <pushcli>
  c = mycpu();
801038cd:	e8 2e fe ff ff       	call   80103700 <mycpu>
  p = c->proc;
801038d2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038d8:	e8 53 0d 00 00       	call   80104630 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
801038ee:	e8 1d 35 00 00       	call   80106e10 <allocuvm>
...
80103900:	e8 bb 32 00 00       	call   80106bc0 <switchuvm>
  return 0;
...
80103924:	e8 e7 35 00 00       	call   80106f10 <deallocuvm>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103949:	e8 f2 0b 00 00       	call   80104540 <pushcli>
  c = mycpu();
8010394e:	e8 ad fd ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103953:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103959:	e8 d2 0c 00 00       	call   80104630 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
80103978:	e8 13 37 00 00       	call   80107090 <copyuvm>
...
801039f1:	e8 fa 0e 00 00       	call   801048f0 <safestrcpy>
...
80103a00:	e8 7b 0b 00 00       	call   80104580 <acquire>
...
80103a13:	e8 88 0c 00 00       	call   801046a0 <release>
...
80103a8e:	e8 ed 0a 00 00       	call   80104580 <acquire>
...
80103af6:	81 c3 54 01 00 00    	add    $0x154,%ebx
      ...
      if (p->priority == min) {
		  ...
		  c->proc = p;
		  switchuvm(p);
80103afc:	e8 bf 30 00 00       	call   80106bc0 <switchuvm>
		  p->state = RUNNING;
...
80103b13:	00 00 00 
		  swtch(&c->scheduler, p->context);
80103b16:	e8 30 0e 00 00       	call   8010494b <swtch>
		  switchkvm();
80103b1b:	e8 80 30 00 00       	call   80106ba0 <switchkvm>
...
80103b40:	e8 5b 0b 00 00       	call   801046a0 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103b55:	e8 e6 09 00 00       	call   80104540 <pushcli>
  c = mycpu();
80103b5a:	e8 a1 fb ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103b5f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b65:	e8 c6 0a 00 00       	call   80104630 <popcli>
sched(void)
{
  int intena;
...
80103b72:	e8 89 09 00 00       	call   80104500 <holding>
...
80103bb3:	e8 93 0d 00 00       	call   8010494b <swtch>
  mycpu()->intena = intena;
...
80103bd0:	68 f0 77 10 80       	push   $0x801077f0
...
80103bdd:	68 1c 78 10 80       	push   $0x8010781c
...
80103bea:	68 0e 78 10 80       	push   $0x8010780e
...
80103bf7:	68 02 78 10 80       	push   $0x80107802
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103c19:	e8 22 09 00 00       	call   80104540 <pushcli>
  c = mycpu();
80103c1e:	e8 dd fa ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103c23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c29:	e8 02 0a 00 00       	call   80104630 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
  ...
  if(curproc == initproc)
80103c2e:	39 1d b8 a5 10 80    	cmp    %ebx,0x8010a5b8
exit(int status)
{
  struct proc *curproc = myproc();
  struct proc *p;
...
80103c37:	8d 73 28             	lea    0x28(%ebx),%esi
80103c3a:	8d 7b 68             	lea    0x68(%ebx),%edi
80103c3d:	89 43 7c             	mov    %eax,0x7c(%ebx)
  if(curproc == initproc)
80103c40:	0f 84 65 01 00 00    	je     80103dab <exit+0x19b>
    panic("init exiting");

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd]){
80103c46:	8b 06                	mov    (%esi),%eax
80103c48:	85 c0                	test   %eax,%eax
80103c4a:	74 12                	je     80103c5e <exit+0x4e>
      fileclose(curproc->ofile[fd]);
80103c4c:	83 ec 0c             	sub    $0xc,%esp
80103c4f:	50                   	push   %eax
80103c50:	e8 db d1 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80103c55:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80103c5b:	83 c4 10             	add    $0x10,%esp
80103c5e:	83 c6 04             	add    $0x4,%esi
  curproc->status = status;
  if(curproc == initproc)
    panic("init exiting");
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80103c61:	39 fe                	cmp    %edi,%esi
80103c63:	75 e1                	jne    80103c46 <exit+0x36>
      fileclose(curproc->ofile[fd]);
      curproc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80103c65:	e8 e6 ee ff ff       	call   80102b50 <begin_op>
  iput(curproc->cwd);
80103c6a:	83 ec 0c             	sub    $0xc,%esp
80103c6d:	ff 73 68             	pushl  0x68(%ebx)
80103c70:	e8 2b db ff ff       	call   801017a0 <iput>
  end_op();
80103c75:	e8 46 ef ff ff       	call   80102bc0 <end_op>
  curproc->cwd = 0;
80103c7a:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)

  acquire(&ptable.lock);
80103c81:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c88:	e8 f3 08 00 00       	call   80104580 <acquire>

  // Parent might be sleeping in wait(0).
  wakeup1(curproc->parent);
80103c8d:	8b 53 14             	mov    0x14(%ebx),%edx
...
80103c98:	eb 12                	jmp    80103cac <exit+0x9c>
80103c9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103ca0:	05 54 01 00 00       	add    $0x154,%eax
80103ca5:	3d 54 82 11 80       	cmp    $0x80118254,%eax
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cbe:	05 54 01 00 00       	add    $0x154,%eax
80103cc3:	3d 54 82 11 80       	cmp    $0x80118254,%eax
...
80103cca:	8b 83 48 01 00 00    	mov    0x148(%ebx),%eax
80103cd0:	31 c9                	xor    %ecx,%ecx
80103cd2:	85 c0                	test   %eax,%eax
80103cd4:	7e 5d                	jle    80103d33 <exit+0x123>
80103cd6:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103cdb:	eb 11                	jmp    80103cee <exit+0xde>
80103cdd:	8d 76 00             	lea    0x0(%esi),%esi
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ce0:	81 c2 54 01 00 00    	add    $0x154,%edx
80103ce6:	81 fa 54 82 11 80    	cmp    $0x80118254,%edx
80103cec:	74 3a                	je     80103d28 <exit+0x118>
			if(p->pid == curproc->p_array[x]){
80103cee:	8b 84 8b 80 00 00 00 	mov    0x80(%ebx,%ecx,4),%eax
80103cf5:	39 42 10             	cmp    %eax,0x10(%edx)
80103cf8:	75 e6                	jne    80103ce0 <exit+0xd0>
80103cfa:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103cff:	eb 13                	jmp    80103d14 <exit+0x104>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d08:	05 54 01 00 00       	add    $0x154,%eax
80103d0d:	3d 54 82 11 80       	cmp    $0x80118254,%eax
80103d12:	74 cc                	je     80103ce0 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan)
80103d14:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103d18:	75 ee                	jne    80103d08 <exit+0xf8>
80103d1a:	39 50 20             	cmp    %edx,0x20(%eax)
80103d1d:	75 e9                	jne    80103d08 <exit+0xf8>
      p->state = RUNNABLE;
80103d1f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103d26:	eb e0                	jmp    80103d08 <exit+0xf8>
  wakeup1(curproc->parent);
  ...
  if(curproc->p_array_sz != 0){
  	for(x = 0; x < curproc->p_array_sz; x++){
80103d28:	83 c1 01             	add    $0x1,%ecx
80103d2b:	39 8b 48 01 00 00    	cmp    %ecx,0x148(%ebx)
80103d31:	7f a3                	jg     80103cd6 <exit+0xc6>
  }
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103d33:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
80103d39:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103d3e:	eb 0e                	jmp    80103d4e <exit+0x13e>
    		}
  	}
  }
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d40:	81 c2 54 01 00 00    	add    $0x154,%edx
80103d46:	81 fa 54 82 11 80    	cmp    $0x80118254,%edx
80103d4c:	74 3a                	je     80103d88 <exit+0x178>
    if(p->parent == curproc){
80103d4e:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103d51:	75 ed                	jne    80103d40 <exit+0x130>
      p->parent = initproc;
      if(p->state == ZOMBIE)
...
80103d57:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103d5a:	75 e4                	jne    80103d40 <exit+0x130>
80103d5c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103d61:	eb 11                	jmp    80103d74 <exit+0x164>
80103d63:	90                   	nop
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d68:	05 54 01 00 00       	add    $0x154,%eax
80103d6d:	3d 54 82 11 80       	cmp    $0x80118254,%eax
80103d72:	74 cc                	je     80103d40 <exit+0x130>
    if(p->state == SLEEPING && p->chan == chan)
80103d74:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103d78:	75 ee                	jne    80103d68 <exit+0x158>
80103d7a:	3b 48 20             	cmp    0x20(%eax),%ecx
80103d7d:	75 e9                	jne    80103d68 <exit+0x158>
      p->state = RUNNABLE;
80103d7f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103d86:	eb e0                	jmp    80103d68 <exit+0x158>
        wakeup1(initproc);
    }
  }
  ...
  curproc->priority = 0;
80103d88:	c7 83 4c 01 00 00 00 	movl   $0x0,0x14c(%ebx)
80103d8f:	00 00 00 
  curproc->state = ZOMBIE;
80103d92:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103d99:	e8 b2 fd ff ff       	call   80103b50 <sched>
  panic("zombie exit");
80103d9e:	83 ec 0c             	sub    $0xc,%esp
80103da1:	68 3d 78 10 80       	push   $0x8010783d
...
80103dae:	68 30 78 10 80       	push   $0x80107830
...
80103dcc:	e8 af 07 00 00       	call   80104580 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103dd1:	e8 6a 07 00 00       	call   80104540 <pushcli>
  c = mycpu();
80103dd6:	e8 25 f9 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103ddb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103de1:	e8 4a 08 00 00       	call   80104630 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103de6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103ded:	e8 5e fd ff ff       	call   80103b50 <sched>
  release(&ptable.lock);
...
80103e15:	8b 5d 08             	mov    0x8(%ebp),%ebx
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103e18:	e8 23 07 00 00       	call   80104540 <pushcli>
  c = mycpu();
80103e1d:	e8 de f8 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103e22:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e28:	e8 03 08 00 00       	call   80104630 <popcli>
*/
...
80103e30:	68 20 2d 11 80       	push   $0x80112d20
80103e35:	e8 46 07 00 00       	call   80104580 <acquire>
  if(priority > 63 || priority < 0){
80103e3a:	83 c4 10             	add    $0x10,%esp
80103e3d:	83 fb 3f             	cmp    $0x3f,%ebx
80103e40:	77 36                	ja     80103e78 <changepriority+0x68>
    return -1; 
  }
...
80103e42:	83 ec 0c             	sub    $0xc,%esp
  ...
  curproc->startpriority = priority; 
80103e45:	89 9e 50 01 00 00    	mov    %ebx,0x150(%esi)
  curproc->priority = priority;
80103e4b:	89 9e 4c 01 00 00    	mov    %ebx,0x14c(%esi)
  curproc->state = RUNNABLE;
80103e51:	c7 46 0c 03 00 00 00 	movl   $0x3,0xc(%esi)
  release(&ptable.lock);  
80103e58:	68 20 2d 11 80       	push   $0x80112d20
80103e5d:	e8 3e 08 00 00       	call   801046a0 <release>
  //cs153 give up control
  yield(); 
80103e62:	e8 59 ff ff ff       	call   80103dc0 <yield>
  return priority;
...
80103e7d:	eb ed                	jmp    80103e6c <changepriority+0x5c>
80103e7f:	90                   	nop
...
80103e8f:	e8 ac 06 00 00       	call   80104540 <pushcli>
  c = mycpu();
80103e94:	e8 67 f8 ff ff       	call   80103700 <mycpu>
  p = c->proc;
...
80103ed0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  ...
  sched();
80103ed7:	e8 74 fc ff ff       	call   80103b50 <sched>
...
80103f0b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  ...
  sched();
80103f12:	e8 39 fc ff ff       	call   80103b50 <sched>
...
80103f4c:	e8 ef 05 00 00       	call   80104540 <pushcli>
  c = mycpu();
80103f51:	e8 aa f7 ff ff       	call   80103700 <mycpu>
  p = c->proc;
...
8010406f:	e8 cc 04 00 00       	call   80104540 <pushcli>
  c = mycpu();
80104074:	e8 87 f6 ff ff       	call   80103700 <mycpu>
  p = c->proc;
...
801043e3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801043e9:	e8 b2 f3 ff ff       	call   801037a0 <myproc>
...
80104523:	e8 d8 f1 ff ff       	call   80103700 <mycpu>
...
80104549:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010454a:	e8 b1 f1 ff ff       	call   80103700 <mycpu>
...
8010455f:	e8 9c f1 ff ff       	call   80103700 <mycpu>
...
801045b4:	e8 47 f1 ff ff       	call   80103700 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
80104613:	e8 e8 f0 ff ff       	call   80103700 <mycpu>
...
8010463b:	75 52                	jne    8010468f <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010463d:	e8 be f0 ff ff       	call   80103700 <mycpu>
...
80104655:	e8 a6 f0 ff ff       	call   80103700 <mycpu>
...
80104669:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104670:	e8 8b f0 ff ff       	call   80103700 <mycpu>
...
80104967:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010496a:	e8 31 ee ff ff       	call   801037a0 <myproc>
...
801049a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049aa:	e8 f1 ed ff ff       	call   801037a0 <myproc>
...
80104a05:	e8 96 ed ff ff       	call   801037a0 <myproc>
...
{
  struct proc *curproc = myproc();
80104a16:	e8 85 ed ff ff       	call   801037a0 <myproc>
...
80104a58:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a5b:	e8 40 ed ff ff       	call   801037a0 <myproc>
...
80104af4:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104af5:	e8 a6 ec ff ff       	call   801037a0 <myproc>
...
80104d14:	e8 87 ea ff ff       	call   801037a0 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104d7b:	e8 20 ea ff ff       	call   801037a0 <myproc>
...
80104eb3:	78 2b                	js     80104ee0 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104eb5:	e8 e6 e8 ff ff       	call   801037a0 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105313:	e8 88 e4 ff ff       	call   801037a0 <myproc>
80105318:	90                   	nop
...
801054e5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054e8:	e8 b3 e2 ff ff       	call   801037a0 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801056a9:	e8 f2 e0 ff ff       	call   801037a0 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801056f2:	e8 a9 e0 ff ff       	call   801037a0 <myproc>
...
8010570e:	75 f0                	jne    80105700 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105710:	e8 8b e0 ff ff       	call   801037a0 <myproc>
...
{
  return fork();
80105744:	e9 f7 e1 ff ff       	jmp    80103940 <fork>
...
80105765:	e8 a6 e4 ff ff       	call   80103c10 <exit>
...
801057a5:	e8 66 e6 ff ff       	call   80103e10 <changepriority>
  return priority;
}
...
801057b6:	e8 e5 df ff ff       	call   801037a0 <myproc>
...
80105837:	78 27                	js     80105860 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105839:	e8 62 df ff ff       	call   801037a0 <myproc>
  if(growproc(n) < 0)
...
80105846:	e8 75 e0 ff ff       	call   801038c0 <growproc>
...
801058cf:	73 2f                	jae    80105900 <sys_sleep+0x90>
    if(myproc()->killed){
801058d1:	e8 ca de ff ff       	call   801037a0 <myproc>
...
80105ac0:	e8 db dc ff ff       	call   801037a0 <myproc>
...
80105b30:	e8 6b dc ff ff       	call   801037a0 <myproc>
80105b35:	85 c0                	test   %eax,%eax
80105b37:	74 0c                	je     80105b45 <trap+0xb5>
80105b39:	e8 62 dc ff ff       	call   801037a0 <myproc>
...
80105b45:	e8 56 dc ff ff       	call   801037a0 <myproc>
80105b4a:	85 c0                	test   %eax,%eax
80105b4c:	74 0b                	je     80105b59 <trap+0xc9>
80105b4e:	e8 4d dc ff ff       	call   801037a0 <myproc>
...
80105b57:	74 57                	je     80105bb0 <trap+0x120>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b59:	e8 42 dc ff ff       	call   801037a0 <myproc>
80105b5e:	85 c0                	test   %eax,%eax
80105b60:	74 1d                	je     80105b7f <trap+0xef>
80105b62:	e8 39 dc ff ff       	call   801037a0 <myproc>
...
80105ba2:	e8 69 e0 ff ff       	call   80103c10 <exit>
...
80105bb4:	75 a3                	jne    80105b59 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105bb6:	e8 05 e2 ff ff       	call   80103dc0 <yield>
...
80105bbd:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105bc0:	e8 bb db ff ff       	call   80103780 <cpuid>
...
80105c07:	e8 74 db ff ff       	call   80103780 <cpuid>
...
80105c76:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit(0);
80105c77:	e9 94 df ff ff       	jmp    80103c10 <exit>
...
80105c85:	e8 86 df ff ff       	call   80103c10 <exit>
...
80105cca:	e8 b1 da ff ff       	call   80103780 <cpuid>
...
80106aa3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106aa6:	e8 d5 cc ff ff       	call   80103780 <cpuid>
...
80106bef:	e8 0c cb ff ff       	call   80103700 <mycpu>
80106bf4:	89 c3                	mov    %eax,%ebx
80106bf6:	e8 05 cb ff ff       	call   80103700 <mycpu>
80106bfb:	89 c7                	mov    %eax,%edi
80106bfd:	e8 fe ca ff ff       	call   80103700 <mycpu>
...
80106c49:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106c4e:	e8 ad ca ff ff       	call   80103700 <mycpu>
80106c53:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c5a:	e8 a1 ca ff ff       	call   80103700 <mycpu>
80106c5f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106c64:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106c68:	e8 93 ca ff ff       	call   80103700 <mycpu>
...
80106c76:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c79:	e8 82 ca ff ff       	call   80103700 <mycpu>
