...
int main(int argc, char ** argv){
  ...
  7c:	89 c3                	mov    %eax,%ebx
        printf(1,"kill %d process\n",going);
  7e:	50                   	push   %eax
  7f:	68 7a 08 00 00       	push   $0x87a
  84:	6a 01                	push   $0x1
  86:	e8 75 04 00 00       	call   500 <printf>
        int j = 0;
        while(j++ < 1000);
        exit(0);
    }
  ...
  b1:	52                   	push   %edx
  b2:	50                   	push   %eax
  b3:	68 2f 08 00 00       	push   $0x82f
  b8:	6a 01                	push   $0x1
  ba:	e8 41 04 00 00       	call   500 <printf>
            if(getpid() == begin+10){
 ...
 157:	50                   	push   %eax
 158:	68 50 08 00 00       	push   $0x850
 15d:	6a 01                	push   $0x1
 15f:	e8 9c 03 00 00       	call   500 <printf>
...
free(void *ap)
{
 ...
 6a1:	a1 34 0b 00 00       	mov    0xb34,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6f9:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 ...
 71a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 71d:	a3 34 0b 00 00       	mov    %eax,0xb34
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 34 0b 00 00    	mov    0xb34,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 78f:	76 3f                	jbe    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	39 05 34 0b 00 00    	cmp    %eax,0xb34
 ...
 7b6:	e8 e5 fe ff ff       	call   6a0 <free>
  return freep;
 7bb:	8b 15 34 0b 00 00    	mov    0xb34,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7df:	89 15 34 0b 00 00    	mov    %edx,0xb34
      return (void*)(p + 1);
 ...
 7f4:	eb e9                	jmp    7df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7f6:	c7 05 34 0b 00 00 38 	movl   $0xb38,0xb34
 7fd:	0b 00 00 
 800:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 38 0b 00 00       	mov    $0xb38,%eax
 80f:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 816:	00 00 00 
