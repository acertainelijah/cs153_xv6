...
int main(int argc, char ** argv){
  ...
  10:	83 ec 2c             	sub    $0x2c,%esp
    ...
    int begin = getpid();
  13:	e8 1a 04 00 00       	call   432 <getpid>
  18:	89 c6                	mov    %eax,%esi
    int pid = fork();
  1a:	e8 8b 03 00 00       	call   3aa <fork>
    int i;
    int status;
    if(pid > 0){
  1f:	83 f8 00             	cmp    $0x0,%eax
  22:	7e 78                	jle    9c <main+0x9c>
  24:	31 db                	xor    %ebx,%ebx
  26:	eb 14                	jmp    3c <main+0x3c>
  28:	90                   	nop
  29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        for(i = 0; i < 15 && pid > 0; i++){
  30:	83 c3 01             	add    $0x1,%ebx
  33:	83 fb 0e             	cmp    $0xe,%ebx
  36:	7f 30                	jg     68 <main+0x68>
  38:	85 c0                	test   %eax,%eax
  3a:	7e 2c                	jle    68 <main+0x68>
            pid = fork();
  3c:	e8 69 03 00 00       	call   3aa <fork>
            if(pid < 0)
  41:	85 c0                	test   %eax,%eax
  43:	79 eb                	jns    30 <main+0x30>
  ...
  6a:	74 34                	je     a0 <main+0xa0>
  6c:	8d 75 e4             	lea    -0x1c(%ebp),%esi
  6f:	90                   	nop
        while(j++ < 1000);
        exit(0);
    }
  ...
  73:	56                   	push   %esi
  74:	e8 41 03 00 00       	call   3ba <wait>
  ...
  95:	6a 00                	push   $0x0
  97:	e8 16 03 00 00       	call   3b2 <exit>
        }
    }else if(pid == 0){
  9c:	75 ce                	jne    6c <main+0x6c>
  9e:	eb f2                	jmp    92 <main+0x92>
                printf(1,"errors occur!\n");
        }
        if (pid == 0){
            int j = 0;
  ...
  a0:	8d 5e 05             	lea    0x5(%esi),%ebx
  a3:	e8 8a 03 00 00       	call   432 <getpid>
  a8:	39 d8                	cmp    %ebx,%eax
  aa:	74 79                	je     125 <main+0x125>

            printf(1,"pid = %d\n",getpid());
  ac:	e8 81 03 00 00       	call   432 <getpid>
  b1:	52                   	push   %edx
  b2:	50                   	push   %eax
  b3:	68 3f 08 00 00       	push   $0x83f
  b8:	6a 01                	push   $0x1
  ba:	e8 51 04 00 00       	call   510 <printf>
            if(getpid() == begin+10){
  bf:	e8 6e 03 00 00       	call   432 <getpid>
  c4:	8d 56 0a             	lea    0xa(%esi),%edx
  c7:	83 c4 10             	add    $0x10,%esp
  ca:	39 d0                	cmp    %edx,%eax
  cc:	74 69                	je     137 <main+0x137>
                printf(1,"pid %d waiting for %d\n",begin+10,begin+5);
                int wpid = waitpid(begin+5,&status,0);
                printf(1,"success clean %d\n",wpid);
            }
            if(getpid() == begin+12){
  ce:	83 c6 0c             	add    $0xc,%esi
  d1:	e8 5c 03 00 00       	call   432 <getpid>
  d6:	39 f0                	cmp    %esi,%eax
  d8:	74 13                	je     ed <main+0xed>
                printf(1,"pid %d waiting for %d\n",begin+12,begin+5);
                int wpid = waitpid(begin+5,&status,0);
                if(wpid == -1)
                    printf(1,"no more waiting for %d\n",begin+5);
  ...
  df:	39 c3                	cmp    %eax,%ebx
  e1:	75 af                	jne    92 <main+0x92>
                exit(5);
  e3:	83 ec 0c             	sub    $0xc,%esp
  e6:	6a 05                	push   $0x5
  e8:	e8 c5 02 00 00       	call   3b2 <exit>
                printf(1,"pid %d waiting for %d\n",begin+10,begin+5);
                int wpid = waitpid(begin+5,&status,0);
                printf(1,"success clean %d\n",wpid);
            }
  ...
  ed:	53                   	push   %ebx
  ee:	50                   	push   %eax
  ef:	68 49 08 00 00       	push   $0x849
  f4:	6a 01                	push   $0x1
  f6:	e8 15 04 00 00       	call   510 <printf>
                int wpid = waitpid(begin+5,&status,0);
  fb:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  fe:	83 c4 0c             	add    $0xc,%esp
 101:	6a 00                	push   $0x0
 103:	50                   	push   %eax
 104:	53                   	push   %ebx
 105:	e8 48 03 00 00       	call   452 <waitpid>
                if(wpid == -1)
 10a:	83 c4 10             	add    $0x10,%esp
 10d:	83 c0 01             	add    $0x1,%eax
 110:	75 c8                	jne    da <main+0xda>
                    printf(1,"no more waiting for %d\n",begin+5);
 112:	50                   	push   %eax
 113:	53                   	push   %ebx
 114:	68 72 08 00 00       	push   $0x872
 119:	6a 01                	push   $0x1
 11b:	e8 f0 03 00 00       	call   510 <printf>
 120:	83 c4 10             	add    $0x10,%esp
 123:	eb b5                	jmp    da <main+0xda>
                printf(1,"errors occur!\n");
        }
        if (pid == 0){
            int j = 0;
 ...
 128:	6a 32                	push   $0x32
 12a:	e8 13 03 00 00       	call   442 <sleep>
 12f:	83 c4 10             	add    $0x10,%esp
 132:	e9 75 ff ff ff       	jmp    ac <main+0xac>
 ...
 137:	53                   	push   %ebx
 138:	50                   	push   %eax
 139:	68 49 08 00 00       	push   $0x849
 13e:	6a 01                	push   $0x1
 140:	e8 cb 03 00 00       	call   510 <printf>
                int wpid = waitpid(begin+5,&status,0);
 145:	8d 45 e4             	lea    -0x1c(%ebp),%eax
 148:	83 c4 0c             	add    $0xc,%esp
 14b:	6a 00                	push   $0x0
 14d:	50                   	push   %eax
 14e:	53                   	push   %ebx
 14f:	e8 fe 02 00 00       	call   452 <waitpid>
                printf(1,"success clean %d\n",wpid);
 154:	83 c4 0c             	add    $0xc,%esp
 157:	50                   	push   %eax
 158:	68 60 08 00 00       	push   $0x860
 15d:	6a 01                	push   $0x1
 15f:	e8 ac 03 00 00       	call   510 <printf>
 164:	83 c4 10             	add    $0x10,%esp
 167:	e9 62 ff ff ff       	jmp    ce <main+0xce>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4af:	f7 f6                	div    %esi
 4b1:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4e8:	e8 e5 fe ff ff       	call   3d2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 628:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 62b:	b8 9b 08 00 00       	mov    $0x89b,%eax
...
free(void *ap)
{
 ...
 6b1:	a1 44 0b 00 00       	mov    0xb44,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 707:	89 08                	mov    %ecx,(%eax)
  freep = p;
 709:	a3 44 0b 00 00       	mov    %eax,0xb44
}
 70e:	5b                   	pop    %ebx
 70f:	5e                   	pop    %esi
 710:	5f                   	pop    %edi
 ...
 72a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 72d:	a3 44 0b 00 00       	mov    %eax,0xb44
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 44 0b 00 00    	mov    0xb44,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 79f:	76 3f                	jbe    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	39 05 44 0b 00 00    	cmp    %eax,0xb44
 ...
 7c6:	e8 e5 fe ff ff       	call   6b0 <free>
  return freep;
 7cb:	8b 15 44 0b 00 00    	mov    0xb44,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7ef:	89 15 44 0b 00 00    	mov    %edx,0xb44
      return (void*)(p + 1);
 ...
 804:	eb e9                	jmp    7ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 806:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 80d:	0b 00 00 
 810:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 817:	0b 00 00 
    base.s.size = 0;
 81a:	b8 48 0b 00 00       	mov    $0xb48,%eax
